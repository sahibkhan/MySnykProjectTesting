<?php
  ...
  $link_1 = mysql_connect("aurora-db-cluster.cluster-cetdkylp4m5f.us-east-1.rds.amazonaws.com", "salman", "GLK_7143#2020Y"); 
  mysql_select_db('auroraerpdb', $link_1);
  ...
  $query_jobcf = "SELECT jobid, cf_1186 as file_title, cf_1188 as location, cf_1190 as department, cf_1198 as ref_no, smcreatorid, smownerid from vtiger_jobcf
						...
						where vtiger_crmentity.deleted=0 AND vtiger_jobcf.jobid='971514' ";
  ...
  while($job_info_detail = mysql_fetch_array($rs_job))
  {
	 ...
	 if($count_last_modified>0)
	 {
		...
		$jrer_cash_r_sum_sql =  'SELECT vtiger_jobexpencereportcf.cf_1349 as buy_local_currency_net,
								 ...
								 AND vtiger_jobexpencereport.owner_id = "'.$job_info_detail['smownerid'].'" 
								 AND vtiger_jobexpencereportcf.cf_1214 IN (85776, 85778,85780,85782, 85784, 85786, 85788, 85790, 85792, 85798, 85800, 85802, 85804, 258706, 205753, 420293, 85796)';
		...
		$jrer_bank_r_sum_sql =  'SELECT vtiger_jobexpencereportcf.cf_1349 as buy_local_currency_net,
								 ...
								 vtiger_jobexpencereportcf.cf_1457="Expence"
								 AND vtiger_jobexpencereport.owner_id = "'.$job_info_detail['smownerid'].'" 
								 AND vtiger_jobexpencereportcf.cf_1214 IN (85775, 85777, 85779, 85781, 85783, 85785, 85787, 85789, 85791, 85797, 85799, 85801, 85803, 258702, 205752, 420287, 85795)';
