<?php
 ...
 mysql_select_db('auroraerpdb', $link_1);
  ...
  $entries = array();
  $query_jobcf = "SELECT vtiger_job.jobid, cf_1186 as file_title, cf_1188 as location, cf_1190 as department,
						...
						where vtiger_crmentity.deleted=0 AND vtiger_job.year_no IN('2019','2020') AND vtiger_jobcf.jobid='1906067'";
