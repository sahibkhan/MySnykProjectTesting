<?php
 ...
 //Port Code select Qry
    if(!empty($_POST["city_id"])) {
	    $sql_portcode = "select airport_code,airport_name From air_codes WHERE city_code='".$_POST["city_id"]."'";
...
//Origin Airport Name  select Qry
   if(!empty($_POST["air_port_code_iata"])) {
	    $sql = "select airport_code,airport_name From air_codes WHERE airport_code = '".$_POST["air_port_code_iata"]."'";
	    $res = $db->getData($sql);
	   // $json_data =   json_encode($res);?>
