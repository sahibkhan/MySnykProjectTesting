...
//select General Origin Cities on the base of General Origin Country instead of USA and Canada 
   ...
   if(!empty($_POST["general_country_id"])) {
	  ...
	  $sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE port_country_code='".$_POST["general_country_id"]."' AND  port_city_code != ''";
	    ...
	    $sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE port_unlocode in (select air_unlocode from air_codes) and port_country_code='".$_POST["country_id"]."' AND  port_city_code != ''";
    ...
    if(!empty($_POST["sea_loading_country_id"])){
   	   ...
   	   $sql = "select DISTINCT port_city_code,port_city From sea_codes WHERE   port_country_code='".$_POST["sea_loading_country_id"]."' AND  port_city_code != ''";
 ...
 if(!empty($_POST["origin_state_code_gernal"])) {
	  $sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE   state_code ='".$_POST["origin_state_code_gernal"]."'  && port_country_code='".$_POST["port_country_code"]."' AND  port_city_code != ''";
   ...
   if(!empty($_POST["origin_state_code"])) {
	  $sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE port_unlocode in (select air_unlocode from air_codes) and  state_code ='".$_POST["origin_state_code"]."'  && port_country_code='".$_POST["port_country_code"]."' AND  port_city_code != ''";
    ...
    if(!empty($_POST["origin_state_code_sea"])) {
	  $sql = "select DISTINCT port_city_code,port_city From sea_codes WHERE  state_code ='".$_POST["origin_state_code_sea"]."'  && port_country_code='".$_POST["port_country_code"]."' AND  port_city_code != ''";
...
//Air Origin AND Destination Country Select on the base of General Origin AND Destination Country 
   if(!empty($_POST["General_Code"]) ) {
   	...
   	$sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE  port_unlocode in (select air_unlocode from air_codes) AND  port_country_code='".$_POST["Origin_Country_Code"]."' AND  port_city_code != ''";
	    $res = $db->getData($sql);
	     //$json_data = json_encode($res);
...
//Destination
   ...
   if(!empty($_POST["Dest_General_Code"])) {
	    ...
	    foreach ($res as $countries) {?>
   	  ...
   	  $sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE  port_unlocode in (select air_unlocode from air_codes) AND  port_country_code='".$_POST["Dest_Destination_Code"]."' AND  port_city_code != ''";
	    $res = $db->getData($sql);
	    $json_data = json_encode($res);
	    //var_dump($json_data);?>
   ...
   if(!empty($_POST["GenralCitySelect"])) {
   	if($_POST["job_origin_states"]!=''){
   		$sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE  port_unlocode in (select air_unlocode from air_codes) and port_country_code='".$_POST["port_country_code"]."' &&  state_code ='".$_POST["job_origin_states"]."' AND  port_city_code != '' ";
   	}else{
	   $sql = "select DISTINCT port_city_code,port_city From air_sea_codes WHERE   port_unlocode in (select air_unlocode from air_codes) AND  port_country_code='".$_POST["port_country_code"]."' AND  port_city_code != ''";
     	}
	    $res = $db->getData($sql);
	    $json_data = json_encode($res);
	    //var_dump($json_data);?>
...
//Sea Loading 
    if(!empty($_POST["GenralCitySelect_Sea"])) {
   	if($_POST["job_origin_states"]!=''){
   		$sql = "select DISTINCT port_city_code,port_city From sea_codes WHERE  port_country_code='".$_POST["port_country_code"]."' &&  state_code ='".$_POST["job_origin_states"]."' AND  port_city_code != '' ";
   	}else{
	    $sql = "select DISTINCT port_city_code,port_city From sea_codes WHERE  port_country_code='".$_POST["port_country_code"]."' AND  port_city_code != ''";
     	}
...
if(! empty($_POST["destcountry_id"])) {
	    $sql = "select DISTINCT city_code,city_name from air_codes WHERE  port_unlocode in (select air_unlocode from air_codes) and country_code='".$_POST["destcountry_id"]."' AND  city_code != ''";
	    $res = $db->getData($sql);
	    $json_data = json_encode($res);
	    //var_dump($json_data);?>
