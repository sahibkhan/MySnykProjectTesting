...
chdir(dirname(__FILE__) . '/../..');
 ...
 // include(dirname(__FILE__)."/../Exchangerate/exchange_rate_class.php");
  ...
  $query_jobcf = "SELECT vtiger_jobcf.jobid, cf_1186 as file_title, cf_1188 as location, cf_1190 as department,
						...
						where vtiger_crmentity.deleted=0 AND vtiger_job.year_no IN('2019') and vtiger_jobcf.jobid='2307799' order by vtiger_crmentity.modifiedtime DESC limit 100 ";
  //and vtiger_jobcf.jobid='2239987'	
