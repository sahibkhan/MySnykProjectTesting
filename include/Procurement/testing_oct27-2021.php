...
//print_r($pricebookarray);exit;
		...
		<tr id="appendtr2" class="listViewEntries" style="max-width:100%">
			...
			<td nowrap="">
		<select onchange="<?php if($Proc_Type_shortcode=='PM') echo 'get_stock(this);'; ?>"  class="<?php if($Proc_Type_shortcode=='PM') echo 'pm_list'; ?> select2 attribute" id="childvalues" name="childvales[]">
...
<td style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="gross[]" readonly id="gross"/></td>
	...
	<select  class="select2 attribute" id="currency" name="currency[]" >
		<option>Select Option</option>
		<?php
