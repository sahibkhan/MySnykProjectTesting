...
//print_r($pricebookarray);exit;
		...
		<tr id="appendtr2" class="listViewEntries" style="max-width:100%">
			...
			<td nowrap="">
		<select required onchange="<?php if($Proc_Type_shortcode=='PM') echo 'get_stock(this);'; ?>"  class="<?php if($Proc_Type_shortcode=='PM') echo 'pm_list'; ?> select2 attribute" id="childvalues" name="childvales[]">
