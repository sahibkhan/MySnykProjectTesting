...
$languageStrings = array(
	...
	'LBL_HR' => 'HR',
	'LBL_FLEET' => 'TFM',
	'LBL_CARGOINSURANCE' => 'INSURANCE',
	'LBL_SURVEY' => 'SURVEY',
	'LBL_PACKINGMATERIAL' => 'PACKING MATERIAL',
	'LBL_LEGAL' => 'LEGAL',
	'LBL_RRSACTIVITY' => 'RRS',
	'LBL_GLKWMS' => 'IMS', //globalink warehouse(Inventory) management system
	'LBL_WAGONSOLUTION' => 'RFM', 
	'LBL_QHSE' => 'QHSE', 
	'LBL_PROCUREMENT' => 'PROCUREMENT', 
	'LBL_GENERAL' => 'GENERAL',
	'LBL_GLOBALINK' => 'Globalink', 
	'LBL_DATABASES' => 'Databases',
	'LBL_HR_Project' => 'HR Projects',
	// Footer
	'APPTITLE' => 'Globalink ERP',
	'POWEREDBY'=> 'Powered by Globalink',
	...
	'LBL_COMPOSE_EMAIL_WARNING' => ' Warning : Your email might land in spam. Add ERP as an authorized sender for your domain. Learn more',
	// Common Link Labels
	...
	'LBL_TYPE_AND_SEARCH' => 'Type and Search',
		'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'For exporting Currency values in Line items, ERP will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'ERP CRM On Demand',
	...
	'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
									ERP contacts and Google contacts(in selected group) updated.<br>
	...
	'LBL_SOCIAL_LINKED' => 'Your ERP is now linked to',
	'LBL_ENTER_KEYWORDS_HELP'=>'ERP will scan twitter and find messages with these words',
	...
	'LBL_ADD_OPPORTUNITY' => 'Add Inquiry',
	'LBL_RETWEET' => 'Retweet',
	...
	'LBL_ROLLUP_COMMENTS_INFO' => "If Roll up is set to 'On' comments on related records will be shown. 
								 For example, if you are viewing comments on an Account record, comments added to related Contacts, Inquiries, Tickets, ..etc would also be displayed.",
	...
	'LBL_SHARED_TAGS_ACCESS'=>'Shared tags are accessible by all users in ERP',
	...
	'LBL_TIME' => 'Time',
	'LBL_SKIPPED' => 'Skipped',
	'vt_create' => 'Records Created in ERP',
	'vt_update' => 'Records Updated in ERP',
	'vt_delete' => 'Records Deleted in ERP',
	'vt_skip' => 'Records skipped in ERP',
	...
	'LBL_SWITCH_TO_VTIGER7_NOW' => 'Switch to ERP7 by Feb 15th',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => 'This %s cannot be saved since duplicate %s exists in GEMS with matching values for %s.',
	'LBL_VTIGER_NOTIFICATION' => 'Message from : ERP System Notifications',
...
$jsLanguageStrings = array(
	...
	'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, ERP will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable ERP field not available for mapping',
	...
	'JS_MORE_VTIGER' => 'There are more records to be synchronized in ERP',
	...
	'JS_LBL_HELP' => 'Help',
	'JS_LBL_HELP_TEXT' => 'Click on Help button to find Guides and FAQs, and use the Help menu dropdown to get assistance from ERP support team',
