        ...
        <div class="pull-right btn-toolbar">
            ...
            <span class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                            <li id="{$MODULE_NAME}_detailView_moreAction_WAGONJCR">
                                    <a href="index.php?module=Jobexpencereport&view=Print&record={$RECORD->getId()}&expense=WagonTrip" target="_blank">                                                                                                  Wagon JCR
                                                </a>
                                            </li>
                                          <li id="{$MODULE_NAME}_detailView_moreAction_WAGONJCRBREADOWN">
                                                <a href="index.php?module=Jobexpencereport&view=Print&record={$RECORD->getId()}&expense=WagonTripBreakdown" target="_blank">
                                                    Wagon Breakdown JCR
                                                </a>
                                            </li> 
