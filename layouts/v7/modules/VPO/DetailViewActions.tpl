    ...
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            <span class="btn-group listViewMassActions">
                                <button class="btn dropdown-toggle" data-toggle="dropdown"><strong>Print VPO</strong>&nbsp;&nbsp;<i class="caret"></i></button>
                                <ul class="dropdown-menu">
                                <li>
                                <a href="index.php?module=VPO&view=Print&template=general&record={$RECORD->getId()}"  target="_blank">  General VPO</a>
                                </li>
                                <li>
                                <a href="index.php?module=VPO&view=Print&template=rrs&record={$RECORD->getId()}" target="_blank">  RRS VPO</a>
                                </li>
