			...
			<table id="listview-table" class="table {if $LISTVIEW_ENTRIES_COUNT eq '0'}listview-table-norecords {/if} listview-table ">
				...
				<tbody class="overflow-y">
					...
					{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
						...
						{/if}
						{if $LISTVIEW_HEADER->get('uitype') eq '768' or $LISTVIEW_HEADER->GET('uitype') eq '599' or $LISTVIEW_HEADER->GET('uitype') eq '1070' or $LISTVIEW_HEADER->GET('uitype') eq '698' or $LISTVIEW_HEADER->GET('uitype') eq '697' or $LISTVIEW_HEADER->GET('uitype') eq '696' or $LISTVIEW_HEADER->GET('uitype') eq '598' or $LISTVIEW_HEADER->GET('uitype') eq '601' or $LISTVIEW_HEADER->GET('uitype') eq '11010' or $LISTVIEW_HEADER->GET('uitype') eq '11012' or $LISTVIEW_HEADER->GET('uitype') eq '11007' or $LISTVIEW_HEADER->GET('uitype') eq '11009' or $LISTVIEW_HEADER->GET('uitype') eq '11008' or $LISTVIEW_HEADER->GET('uitype') eq '12001' or $LISTVIEW_HEADER->GET('uitype') eq '995'  or $LISTVIEW_HEADER->GET('uitype') eq '695' or $LISTVIEW_HEADER->GET('uitype') eq '597' or $LISTVIEW_HEADER->GET('uitype') eq '13001' }
                		{assign var=LISTVIEW_ENTRY_VALUE value=$LISTVIEW_ENTRY->getDisplayValue($LISTVIEW_HEADERNAME)}
						{else}
							...
							<span class="fieldValue">
								<span class="value">
									{if ($LISTVIEW_HEADER->isNameField() eq true or $LISTVIEW_HEADER->get('uitype') eq '4') and $MODULE_MODEL->isListViewNameFieldNavigationEnabled() eq true }
										<a href="{$LISTVIEW_ENTRY->getDetailViewUrl()}&app={$SELECTED_MENU_CATEGORY}">
										{if $LISTVIEW_HEADER->GET('uitype') eq '698'}
