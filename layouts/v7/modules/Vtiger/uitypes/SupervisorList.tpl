...
{assign var=SUPERVISOR_LIST value=$FIELD_MODEL->getSupervisorList()}
...
{foreach item=USER_NAME key=USER_ID from=$SUPERVISOR_LIST}
...
<input type="hidden" id="direct_supervisor" name="direct_supervisor" value="{$USER_ID}">
{/strip}