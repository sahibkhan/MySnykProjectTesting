							...
							<div class="media-body">
								<div class="comment" style="line-height:1;">
									...
									<span class="commentTime text-muted cursorDefault">
										...
										<small title="{Vtiger_Util_Helper::formatDateTimeIntoDayString($COMMENT->getCommentedTime())}">{Vtiger_Util_Helper::formatDateTimeIntoDayString($COMMENT->getCommentedTime())}</small>
									</span>
									...
									{if $COMMENT->getCommentedTime() neq $COMMENT->getModifiedTime()}
										...
										<div class="commentEditStatus" name="editStatus">
											...
											<div style="margin-top:5px;" class="text-muted">
												...
												<small title="{Vtiger_Util_Helper::formatDateTimeIntoDayString($COMMENT->getModifiedTime())}" class="commentModifiedTime">{Vtiger_Util_Helper::formatDateTimeIntoDayString($COMMENT->getModifiedTime())}</small>
											</div>
										</div>
									{/if}
