					...
					<div class="dropdown app-modules-dropdown-container">
						...
						<ul class="dropdown-menu app-modules-dropdown" aria-labelledby="{$APP_NAME}_modules_dropdownMenu">
							{if $APP_NAME=='MARKETING'}
								<li>
									<a href="#" title="Presentations" >
										<span class="module-icon"><i class="fa fa-file-powerpoint" title="Presentations"></i></span>
										<span class="module-name textOverflowEllipsis">Presentations</span>
									</a>
								</li>
								<li>
									<a href="#" title="Advertisements" >
										<span class="module-icon"><i class="fa fa-ad" title="Advertisements"></i></span>
										<span class="module-name textOverflowEllipsis">Advertisements</span>
									</a>
								</li>
								<li>
									<a href="#" title="News Letters" >
										<span class="module-icon"><i class="fa fa-newspaper" title="News Letters"></i></span>
										<span class="module-name textOverflowEllipsis"> News Letters</span>
									</a>
								</li>
								<li>
									<a href="#" title="Company Profiles" >
										<span class="module-icon"><i class="fa fa-file" title="Company Profiles"></i></span>
										<span class="module-name textOverflowEllipsis"> Company Profiles</span>
									</a>
								</li>
								<li>
									<a href="#" title="Certifications" >
										<span class="module-icon"><i class="fa fa-certificate" title="Certifications"></i></span>
										<span class="module-name textOverflowEllipsis"> Certifications</span>
									</a>
								</li>
								<li>
									<a href="#" title="Memberships" >
										<span class="module-icon"><i class="fa fa-network-wired" title="Memberships"></i></span>
										<span class="module-name textOverflowEllipsis"> Memberships</span>
									</a>
								</li>
								<li>
									<a href="#" title="Stationary Templates" >
										<span class="module-icon"><i class="fa fa-envelope" title="Stationary Templates"></i></span>
										<span class="module-name textOverflowEllipsis"> Stationary Templates</span>
									</a>
								</li>
							{/if}
							...
							{if $APP_NAME=='QHSE'}
								<li>
									<a href="manual/index.php" title="SOP / Manual" target="_blank">
										<span class="module-icon"><i class="fa fa-book" title="SOP / Manual"></i></span>
										<span class="module-name textOverflowEllipsis">SOP / Manual</span>
									</a>
								</li>								
							{/if}
						</ul>
