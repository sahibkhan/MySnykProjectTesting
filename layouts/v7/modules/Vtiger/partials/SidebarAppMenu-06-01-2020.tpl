				...
				{if count($APP_GROUPED_MENU.$APP_NAME) gt 0}
					<div class="dropdown app-modules-dropdown-container">
						...
						<ul class="dropdown-menu app-modules-dropdown" aria-labelledby="{$APP_NAME}_modules_dropdownMenu">
							...
							{if $APP_NAME=='SUPPORT'}
								<li>
									<a href="manual/index.php" title="ERP Manual" target="_blank">
										<span class="module-icon"><i class="fa fa-book" title="FAQ"></i></span>
										<span class="module-name textOverflowEllipsis"> ERP Manual</span>
									</a>
								</li>
							{/if}
						</ul>
