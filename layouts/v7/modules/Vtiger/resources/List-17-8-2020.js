...
Vtiger.Class("Vtiger_List_Js", {
	...
	triggerMassEdit: function (url) {
		...
		if(module_name=='TruckTracking')
		{
			var cvId = listInstance.getCurrentCvId();
			var params = {
				//'selected_ids': JSON.stringify("2440200"),
				//'excluded_ids': [""],
				'viewname': cvId
			}
		}if(module_name=='WaggonTracker')
		{
			var cvId = listInstance.getCurrentCvId();
			var params = {
				//'selected_ids': JSON.stringify("2440200"),
		...
		//alert(JSON.stringify(module_name));
		if (params) {
