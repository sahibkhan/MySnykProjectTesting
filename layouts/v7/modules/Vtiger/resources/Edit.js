...
Vtiger_Index_Js("Vtiger_Edit_Js",{
    ...
    */
    ...
    preloadAnimation: function(container) {
		var input = jQuery('input.ui-autocomplete-input', container);
		
		input.on('input', function() {
			
			if (jQuery(this).val().length >= 3) {
				jQuery('.custom_preloader').remove();
				jQuery( "<div class='custom_preloader' style='background-color:#2196f3; color: white; padding: 3px 8px; max-width: 200px;'><div class='lds-ring'><div></div><div></div><div></div><div></div></div> Loading</div><style class='custom_preloader'>.lds-ring {  display: inline-block;  position: relative;  width: 15px;  height: 15px;}.lds-ring div {  box-sizing: border-box;  display: block;  position: absolute;  width: 100%;  height: 100%;  margin-top: 3px;  border: 2px solid #fff;  border-radius: 50%;  animation: lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;  border-color: #fff transparent transparent transparent;}.lds-ring div:nth-child(1) {  animation-delay: -0.45s;}.lds-ring div:nth-child(2) {  animation-delay: -0.3s;}.lds-ring div:nth-child(3) {  animation-delay: -0.15s;}@keyframes lds-ring {  0% {    transform: rotate(0deg);  }  100% {    transform: rotate(360deg);  }}</style>" ).insertAfter(this);
			} else{
				if (jQuery('.custom_preloader').length) {
					jQuery('.custom_preloader').remove();
				}
			}
