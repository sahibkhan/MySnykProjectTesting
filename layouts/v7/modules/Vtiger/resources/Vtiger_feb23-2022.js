...
Vtiger.Class('Vtiger_Index_Js', {
	...
	registerAutoCompleteFields : function(container) {
		var thisInstance = this;
		container.find('input.autoComplete, input#Accounts_editView_fieldName_accountname, input#Accounts_editView_fieldName_cf_2395').autocomplete({
			'minLength' : '3',
			'source' : function(request, response){
				...
				if (jQuery('#QuickCreate').length > 0) {
					...
					// if (jQuery('input#Accounts_editView_fieldName_accountname').length && jQuery('input').attr('id') != 'Accounts_editView_fieldName_accountname') {
