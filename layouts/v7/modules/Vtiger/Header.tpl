...
<html>
	<head>
        ...
        <link rel="SHORTCUT ICON" href="{vresource_url('layouts/v7/skins/images/favicon.ico')}">
        ...
        <link type='text/css' rel='stylesheet' href="{vresource_url('layouts/v7/lib/font-awesome/css/fontawesome.min.css')}" >
        <link type='text/css' rel='stylesheet' href="{vresource_url('layouts/v7/lib/font-awesome/css/brands.min.css')}" >
        <link type='text/css' rel='stylesheet' href="{vresource_url('layouts/v7/lib/font-awesome/css/solid.min.css')}" >
	...
	<body data-skinpath="{Vtiger_Theme::getBaseThemePath()}" data-language="{$LANGUAGE}" data-user-decimalseparator="{$CURRENT_USER_MODEL->get('currency_decimal_separator')}" data-user-dateformat="{$CURRENT_USER_MODEL->get('date_format')}"
          ...
          data-user-calendar-reminder-interval="{$CURRENT_USER_MODEL->getCurrentUserActivityReminderInSeconds()}">
            {literal}
                ...
                <noscript><div><img src="https://mc.yandex.ru/watch/91568782" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
                <!-- /Yandex.Metrika counter -->
            {/literal}
