              ...
              {foreach key=TYPE item=TYPE_MODEL from=$TYPES}
                <tr class="listViewEntries" id="2" name="everyrecord[]">
                  ...
                  <td id="upload_edocument" class="relatedListEntryValues" colspan="1">
                    <input id="EDocuments_editView_fieldName_upload_edocument" type="file" data-fieldname="upload_edocument" data-fieldtype="string" multiple="" class="inputElement multi max-6  MultiFile-applied" name="upload_edocument[{$TYPE_MODEL['echecklistid']}][]" value="">
                  </td>
                </tr>
              {/foreach}
            {/if}
