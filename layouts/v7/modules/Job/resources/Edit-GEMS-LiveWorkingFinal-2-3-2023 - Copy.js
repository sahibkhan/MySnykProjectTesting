            ...
            if (job_status === 'Completed') {
                ...
                if (Array.isArray(mode)) {
                    ...
                    if (mode == 'Air') {
                        ...
                        $('[name="job_air_origin_city"]').attr("required", "required");
                        $('[name="job_air_destination_city"]').attr("required", "required");
                        $('[name="job_air_origin_port_code"]').attr("required", "required");
                        $('[name="job_air_destination_port_code"]').attr("required", "required");
                        $('[name="job_air_origin_airport_name"]').attr("required", "required");
                        $('[name="job_air_destination_airport_name"]').attr("required", "required");

                        $('[name="cf_8654"]').attr("required", "required");
                        $('[name="cf_8656"]').attr("required", "required");
                        $('[name="cf_8584"]').attr("required", "required");
                        $('[name="cf_4931"]').attr("required", "required");
                        $('[name="cf_4933"]').attr("required", "required");
                        $('[name="cf_4935"]').attr("required", "required");
                        $('[name="cf_4925"]').attr("required", "required");
                        $('[name="cf_1082"]').attr("required", "required");

                    } else if (mode == 'Ocean') {
                        $('[name="job_sea_loading_city"]').attr("required", "required")
                        $('[name="job_sea_discharge_city"]').attr("required", "required")
                        $('[name="job_sea_loading_port_code"]').attr("required", "required")
                        $('[name="job_sea_discharge_port_code"]').attr("required", "required")

                        $('[name="job_sea_loading_port_code"]').attr("required", "required");
                        $('[name="job_sea_discharge_port_code"]').attr("required", "required");
                        $('[name="cf_8614"]').attr("required", "required");
                        $('[name="cf_8616"]').attr("required", "required");
                        $('[name="cf_8618"]').attr("required", "required");
                        $('[name="cf_8946"]').attr("required", "required");
                        $('[name="cf_8622"]').attr("required", "required");
                    } else if (mode == 'Air/Sea') {
                        $('[name="job_air_origin_city"]').attr("required", "required");
                        $('[name="job_air_destination_city"]').attr("required", "required");
                        $('[name="job_air_origin_port_code"]').attr("required", "required");
                        $('[name="job_air_destination_port_code"]').attr("required", "required");
...
function checkReconciled(){
    ...
    if (_USERMETA['id'] == '405' &&  (job_status == 'No Costing' || job_status == 'In Progress' || job_status == 'Request For Cancellation' || job_status == 'Cancelled' || job_status == 'Request For Revision' || job_status == 'Revision'))  {
        ...
        $('select[data-fieldname="cf_8966"]').prop('disabled', true);
    }
...
$('select[data-fieldname="job_origin_states"]').change(function(e) {
    ...
    if (origin_state_code != '' && port_country_code != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                origin_state_code_gernal: origin_state_code,
    ...
    if (air_origin_state_code_general != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                air_origin_state_code_general: air_origin_state_code_general,
                port_country_code: port_country_code
            },
            success: function(data) {
...
$('select[data-fieldname="job_sea_loading_state"]').change(function(e) {
    ...
    if (origin_state_code != '' && port_country_code != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                origin_state_code_sea: origin_state_code,
                port_country_code: port_country_code
            },
            success: function(data) {
                $('select[data-fieldname="job_sea_loading_city"]').prop('disabled', false);
...
$('select[data-fieldname="cf_1506"]').change(function(e) {
    ...
    if (Dest_General_Code != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                Dest_General_Code: Dest_General_Code
            },
            success: function(data) {
...
$('select[data-fieldname="cf_1508"]').change(function(e) {
    ...
    if (port_country_code != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                GenralCitySelect: GenralCitySelect,
                port_country_code: port_country_code,
                job_origin_states: job_origin_states
            },
            success: function(data) {
                $('select[data-fieldname="job_air_origin_port_code"]').val('')
                $('select[data-fieldname="job_air_origin_city"]').html(data);
    ...
    if (GenralCitySelect_Sea != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                GenralCitySelect_Sea: GenralCitySelect_Sea,
                port_country_code: port_country_code,
                job_origin_states: job_origin_states
            },
            success: function(data) {
    ...
    if (GenralCitySelect != '') {
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                city_id_air_code: GenralCitySelect,
                country: port_country_code
            },
            success: function(data) {
    ...
    if (GenralCitySelect_Sea != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                city_id_air_code_sea: GenralCitySelect,
                country: port_country_code
            },
            success: function(data) {
                // alert(JSON.stringify(data[0].port_country_code));
    ...
    if (AirportName_CODE != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                AirportName_CODE: AirportName_CODE,
                country: port_country_code
            },
            success: function(data) {
                // alert(JSON.stringify(data[0].port_country_code));
    ...
    if (GenralCitySelect_CODE != '') {
        ...
        $.ajax({
            ...
            data: {
                GenralCitySelect_CODE: GenralCitySelect_CODE,
                country: port_country_code
            },
            dataType: 'json',
            success: function(data) {
...
$('select[data-fieldname="job_air_origin_city"]').change(function(e) {
    ...
    if (origin_airport_code != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                AirportName_CODE: origin_airport_code,
                country: country
            },
            success: function(data) {
                $('select[data-fieldname="job_air_origin_airport_name"]').html(data);
...
$('select[data-fieldname="job_air_origin_port_code"]').change(function(e) {
    ...
    if (job_air_origin_port_code != '') {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                job_air_origin_port_code: job_air_origin_port_code,
                cityId: cityId,
                country: country
            },
            success: function(data) {
...
$('select[data-fieldname="job_sea_loading_country"]').change(function(e) {
    ...
    if (countryId == "US" || countryId == "CA") {
        ...
        $.ajax({
            ...
            url: "include/Job/getairdata.php",
            data: {
                sea_loading_country_id: countryId
            },
            success: function(data) {
                $('select[data-fieldname="job_sea_loading_state"]').val('');
                $('select[data-fieldname="job_sea_loading_state"]').prop('disabled', true);
    ...
    if (air_port_code_iata != '') {
        $.ajax({
            ...
            data: {
                city: city,
                country: country,
                air_port_code_iata: air_port_code_iata
            },
            dataType: 'json',
            success: function(data) {
...
$("#dataTable").on('click', '.delete', function(e) {
    ...
    if (deleteid != '') {
        ...
        if (confirmalert == true) {
            ...
            $.ajax({
                type: "POST",
                url: "include/Job/multipledelete.php",
                data: {
                    deleteid: deleteid
                },
                dataType: 'json',
