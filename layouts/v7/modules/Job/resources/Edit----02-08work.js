...
$(document).ready(function() {
	 ...
	 var recordId = jQuery('[id="recordId"]').val();
    ...
    $.ajax({
               ...
               console.log('After Ajax tst Details');
                // if your table has header(th), use this
                //$('td:nth-child(2),th:nth-child(2)').hide();
               
	           	//console.log('After Ajax tst ts');
              //  $('.block block_Air Shipments').hide();

	           //	 $('.table detailview-table no-border span').html(data);
	          // 	console.log(data[0].country_name);
	           //var te =	$('.Job_detailView_fieldValue_job_air_origin_country span').text(data[0].country_name);
                 // $('#Job_detailView_fieldValue_job_air_origin_country span').html('set your value as you want');
	          // var te =  $('#Job_detailView_fieldValue_job_air_origin_country').html('test');
	            //alert(te);
	            } 
