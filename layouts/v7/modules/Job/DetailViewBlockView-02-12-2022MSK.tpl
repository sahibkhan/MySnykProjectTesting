	...
	{foreach key=BLOCK_LABEL_KEY item=FIELD_MODEL_LIST from=$RECORD_STRUCTURE}
		...
		<div class="block block_{$BLOCK_LABEL_KEY}" data-block="{$BLOCK_LABEL_KEY}" data-blockid="{$BLOCK_LIST[$BLOCK_LABEL_KEY]->get('id')}">
			...
			<div class="blockData">
                ...
                {if $BLOCK_LABEL_KEY eq "Sea Shipments" &&  $BLOCK_LIST[$BLOCK_LABEL_KEY]->get('id') eq '903'}
							...
							<table  class="table table-responsive">		
								...
								<TR>
									<TD>
										{$FIELD_MODEL['container_type']}
									</TD>

									<TD>
										{$FIELD_MODEL['container_size']}
									</TD>	
									<TD>
									      {$FIELD_MODEL['container_qty']}							
									 </TD>
									<TD>
										{$FIELD_MODEL['container_fcl_lcl']} 
									</TD>	
