...
{if $USERTYPE eq 'Job Owner'}
   {if $ASSIGNEE_COUNT > 0 }
      ...
      <div class="relatedContents col-lg-12 col-md-12 col-sm-12 table-container">
         ...
         <p><strong>Job Assignee # Akmaral Checklist</strong><p>
         <p><strong>Coordinator name : Marina S. / AXG / KZ </strong>
            ...
            <div class="bottomscroll-div">
               <table id="listview-table" class="table listview-table listViewEntriesTable">
                  ...
                  <tbody>
                     ...
                     {foreach key=row_no item=doc from=$ASSIGNEE_EDOCS}   
                        <tr></tr>
                        <tr class="listViewEntries" data-id="4802585">
                          <td>Optional</td>
                          <td>{$doc.name}</td>
                          <td>{$doc.upload_document_clone}</td>
                        </tr>
                     {/foreach}
