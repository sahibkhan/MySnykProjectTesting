					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<div style="margin-left: 50px;">
									<div>
										<select class="inputElement select2" name="Exporttype" style="width:150px !important;" >
										<option value="finance_format">Finance Format</option>
										<option value="kerry_format">Kerry Format</option>
										<option value="kpi">KPI Format</option>
										<option value="vendor">Vendor JCR</option>
										<option value="profit_share">Profit Share Format</option>
										<option value="dxb">DXB Formate</option>
										<option value="data_collection">Globalink Data Collection</option>
										<option value="scope_data_collection_air">Data Collection(Air)</option>
										<option value="scope_data_collection_sea">Data Collection(Sea)</option>

										</select>
										<label style="font-weight:normal" for="csv">&nbsp;&nbsp;Report Format</label>
									</div>
							</div>
