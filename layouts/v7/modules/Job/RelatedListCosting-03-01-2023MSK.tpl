...
{strip} 
	...
	<div class="relatedContainer">
		...
		{if $PARENT_RECORD->get('assigned_user_id') eq $USER_MODEL->getId()}
								 ...
								 {if $HEADER_FIELD@first}	
										...
										<div class="pull-left">
											<span class="actionImages">
												...
												<a target="_blank" href="index.php?module=VPO&view=Detail&record={$RELATED_RECORD->get('vpo_view_id')}&mode=showDetailViewByMode&requestMode=full"><i title="" class="fa fa-list alignMiddle"></i></a>
										...
										<div class="pull-left">
											...
											{if $RELATED_RECORD->get('bo_view_id') neq ''}
												<a target="_blank" href="index.php?module=BO&view=Detail&record={$RELATED_RECORD->get('bo_view_id')}&mode=showDetailViewByMode&requestMode=full" title="View Booking Order"><i title="" class="fa fa-list alignMiddle"></i></a>
