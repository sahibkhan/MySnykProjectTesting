...
{strip}
    ...
    <div id="listview-actions" class="listview-actions-container">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            *}
                            ...
                            <li class="selectFreeRecords">
                                    <a data-toggle="modal" data-target="#jobassignmodal">Job Assignment Report</a>                  
                            </li>
                        </ul>
                    </div>
                {/if}

                    {if $CURRENT_USER_MODEL->getId() eq 1044 or $CURRENT_USER_MODEL->getId() eq 1 or $CURRENT_USER_MODEL->getId() eq 752 or $CURRENT_USER_MODEL->getId() eq 420 or $CURRENT_USER_MODEL->getId() eq 419}	
                    <button type="button" id="sendto1c" class="btn addButton btn-default module-buttons" style="margin-left:5px; margin-top:0px;" ><strong>Send to 1C</strong></button>
                    {/if}	
     ...
     <link rel="stylesheet" href="libraries/w3/w3.css">
    <span id="arraytt" style="display:none">
        <div class="w3-light-grey">
        <div id="myBar" class="w3-container w3-green" style="height:24px; padding:0px !important">
        </div>
        </div>
        <p id="myP">Added <span id="demo">0</span> of <span id="demo1"></span></p>
    </span>
{/strip}
{* Job Assignment report starts *}
<div class="bootbox modal fade" id="jobassignmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only"></span></button>
        <h4 class="modal-title" id="myModalLabel"> Job Assignment report </h4>
      </div>
      <div class="modal-body">
        ...
        <table>
          <tr> 
            <td> From Date </td>
            <td> 
                 <input class="MISReportPeriodFrom date-from" type="text" data-date-format="yyyy-mm-dd" value="" />
            </td>
          </tr>
          <tr>
            <td>    
            ...
            <td>    
                 <input class="MISReportPeriodTo date-to" type="text" data-date-format="yyyy-mm-dd" value=""  />
            </td>         
          ...
          <tr> 
            <td> Select User </td>
            <td>
                  {* {php} include('include/Job/rolebasedusers.php'); {/php} *}
          ...
          <tr> 
            ...
            <option value="financial">Financial Format</option>
            <option value="vendor">Vendor JCR</option>
            </select>
         ...
         {*  <tr> 
            <td> Position </td>
            <td>
                  <select class="chzn-select" name="userprofile-position" id="userprofile-position">
                    {php} include('include/Reports/position.php'); {/php}  
                  </select>
      ...
      <div class="modal-footer">        
         <button type="button" class="btn btn-primary" id="generate_job_assignement" data-dismiss="modal">Generate report</button>
      </div>
      
    </div>
  </div>
</div>
{* Job Assignment report ends *}  