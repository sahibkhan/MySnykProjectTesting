...
{strip}
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            {if $JRER_USER_ID_FLAG eq 'yes'}
            
            <li><a href="index.php?module=JER&view=Print&record={$RECORD->getId()}" target="_blank">Job Costing Report</a></li>
            <li><a href="index.php?module=Jobexpencereport&view=Print&record={$RECORD->getId()}&expense=JCR&type=JCR" target="_blank">Job Completion Report</a></li>
            <li><a href="index.php?module=Jobexpencereport&view=Print&record={$RECORD->getId()}&expense=JCR&type=LJCR" target="_blank">Local JCR</a></li>
            {else}
            <li><a href="index.php?module=Jobexpencereport&view=Print&record={$RECORD->getId()}&userid={$SUB_JRER_USER_ID}&expense=SUBJCR&type=JCR" target="_blank">Job Completion Report</a></li>
            <li><a href="index.php?module=Jobexpencereport&view=Print&record={$RECORD->getId()}&userid={$SUB_JRER_USER_ID}&expense=SUBJCR&type=LJCR" target="_blank">Local JCR</a></li>
           
            {/if}
            <li><a href="index.php?module=Job&view=Print&record={$RECORD->getId()}" target="_blank">Job File Cover</a></li>
            <li onclick="window.open('index.php?module=Job&view=Print&type=pod&record={$RECORD->getId()}', 'Proof Of Delivery', 'width=600,height=400,resizable=no');"><a>Proof Of Delivery</a></li>
            <!-- add by Azhar 15 nov 2022 -->
			<li onclick="window.open('index.php?module=Job&view=Print&type=podeng&record={$RECORD->getId()}', 'Proof Of Delivery (English)', 'width=600,height=400,resizable=no');"><a>Proof Of Delivery (English)</a></li>
			
            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#StickerPrintModal" target="_blank">Sticker Print</a></li>


            <li><a href="index.php?module=Job&view=Print&type=edocuments&record={$RECORD->getId()}" target="_blank">Edocuments</a></li>

            <li><a href="index.php?module=Job&view=Print&type=edocs&record={$RECORD->getId()}" target="_blank">Edocs</a></li>
