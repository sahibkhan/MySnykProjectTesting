         ...
         <div class="bottomscroll-div">
            <table id="listview-table" class="table listview-table listViewEntriesTable">
               ...
               <tbody>
                     ...
                     {foreach key=row_no item=doc from=$DOCS}   
                        ...
                        <tr class="listViewEntries" data-id="4802585">
                           <td class="related-list-actions">
                              {if $JOBSTATUS neq 'Archive Received' && $JOBSTATUS neq 'Passed to Archive' && $JOBSTATUS neq 'Request For Revision'}
                              {if $USERID neq '405'}
                  ...
                  {*\before uploading*}
                  {if $DOC_COUNT eq 0 && $JOBSTATUS neq 'Archive Received' && $JOBSTATUS neq 'Passed to Archive' && $JOBSTATUS neq 'Request For Revision'}
                  {** {if {$TYPES_COUNT} > 0}   **}
                  ...
                  <tr class="listViewEntries" id="2" name="everyrecord[]">
                     ...
                     <td id="document_name" class="fieldLabel col-lg-2">
                        <select class="select2 inputElement" name="document_name[]">
                  ...
                  {if $DOC_COUNT > 0 && $JOBSTATUS neq 'Archive Received' && $JOBSTATUS neq 'Passed to Archive' && $JOBSTATUS neq 'Request For Revision'}
                  {foreach key=TYPE item=TYPE_MODEL from=$TYPES}
                  ...
                  <tr class="listViewEntries" id="2" name="everyrecord[]">
                     ...
                     <td id="upload_edocument" class="relatedListEntryValues" colspan="1">
                        {if $JOBSTATUS eq 'Completed' || $JOBSTATUS eq 'Returned for Additional Uploading' || $JOBSTATUS eq 'Revision'}
                        <input id="EDocs_editView_fieldName_upload_edocument" type="file" data-fieldname="upload_edocument" data-fieldtype="string" multiple="" class="inputElement multi max-6  MultiFile-applied" name="upload_edocument[{$TYPE_MODEL['echecklistid']}][]" value="">
               ...
               <tfoot>
                  <tr class="listViewEntries">
                     <td  nowrap=""  class="relatedListEntryValues" align="right" colspan="3"> 
                        ...
                        {if $JOBSTATUS neq 'Archive Received' && $JOBSTATUS neq 'Passed to Archive' && $JOBSTATUS neq 'Request For Revision' && $JOBSTATUS neq 'Cancelled' && $USERID neq '405' && $USERID neq '277'}
                           <button style="margin:20px;" class="btn btn-success btn-lg" type="submit" name="saveButton" ><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
                        {/if}
