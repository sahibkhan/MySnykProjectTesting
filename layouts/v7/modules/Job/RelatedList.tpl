						...
						<tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
							...
							<td class="related-list-actions">
								<span class="actionImages">&nbsp;&nbsp;&nbsp;
									...
									{if $RELATED_MODULE_NAME eq 'CargoInsurance'}	
									<a href="index.php?module=CargoInsurance&view=Print&record={$RELATED_RECORD->getId()}" target="_blank"><i title="Print Insurance" class="fa fa-print alignMiddle"></i></a>&nbsp;&nbsp;
									<a href="index.php?module=CargoInsurance&view=Print&record={$RELATED_RECORD->getId()}&type=certificate" target="_blank"><i title="Print Certificate" class="fa fa-print alignMiddle"></i></a>&nbsp;&nbsp;
                                   {/if}
								   
								   <!-- change by Azhar 23 sep 2022 -->
								   {if $RELATED_MODULE_NAME eq 'ShippingInsurance'}	
									<a href="index.php?module=ShippingInsurance&view=Print&record={$RELATED_RECORD->getId()}" target="_blank"><i title="Print Insurance" class="fa fa-print alignMiddle"></i></a>&nbsp;&nbsp;
									<a href="index.php?module=ShippingInsurance&view=Print&record={$RELATED_RECORD->getId()}&type=certificate" target="_blank"><i title="Print Certificate" class="fa fa-print alignMiddle"></i></a>&nbsp;&nbsp;
                                   {/if}
									...
									{if $RELATED_MODULE_NAME neq 'JobTask'}
									<a href="{$RELATED_RECORD->getDetailViewUrl()}"  target="_blank">
									&nbsp;&nbsp;<i title="Complete Details" class="fa fa-th-list alignMiddle"></i>
									</a>	
									{/if}
								</span>
