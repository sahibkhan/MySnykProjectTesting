								...
								<span class="value">
									...
									{else}
										...
										{else if $LISTVIEW_HEADER->get('uitype') eq '71'}
											...
											{/if}								
										{else if in_array($LISTVIEW_HEADER->get('uitype'),array(14063,14064,14065,14066,15060,15061,15062,15063,15064,15065,13071,13072,14062,15072,13081,13082))}
										              
                     {vtranslate($LISTVIEW_HEADER->getDisplayValue({$LISTVIEW_ENTRY_VALUE}))}
                    {else if in_array($LISTVIEW_HEADER->get('uitype'),array(13061))}
										              
                     {vtranslate($LISTVIEW_HEADER->getDisplayValue({$LISTVIEW_ENTRY_VALUE},{$LISTVIEW_ENTRY_VALUE}))}             
