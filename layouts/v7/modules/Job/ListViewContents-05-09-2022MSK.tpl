								...
								<span class="value">
									...
									{else}
										...
										{else if $LISTVIEW_HEADER->get('uitype') eq '71'}
											...
											{/if}								
										{else if in_array($LISTVIEW_HEADER->get('uitype'),array(13061,14063,14064,14065,14066,15060,15061,15062,15063,15064,15065,13063,13064,14061,13062,13063,13064,14061,15071,13071,13072,14062,15072,13081,13082))}
