		...
		{include file="partials/RelatedListHeader.tpl"|vtemplate_path:$RELATED_MODULE_NAME}
			...
			<div class="relatedContents col-lg-12 col-md-12 col-sm-12 table-container" style="margin-top: 10px;">
                ...
                <tr class="listViewEntries">    
                    ...
                    <a href="SubJCR_export_pdf.php?record={$ASSIGNED_USER['job_id']}&userid={$ASSIGNED_USER['user_id']}" target="_blank" title=""><i class="fa fa-print alignMiddle" title="Job Completion Report from {$ASSIGNED_USER['cf_1559']} {$ASSIGNED_USER['cf_1542']}"></i></a>
                    &nbsp;&nbsp;
                    <a href="SubJCR_local_export_pdf.php?record={$ASSIGNED_USER['job_id']}&userid={$ASSIGNED_USER['user_id']}" target="_blank" title=""><i class="fa fa-print alignMiddle" title="Local JC Report from {$ASSIGNED_USER['cf_1559']} {$ASSIGNED_USER['cf_1542']}"></i></a>
                    </td>
                </tr>    
                 {/foreach}   
                </tbody>
