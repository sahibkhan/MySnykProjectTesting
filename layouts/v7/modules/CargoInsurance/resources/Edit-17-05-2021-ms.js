	...
	init : function(container) {
	 ...
	 getCargoRate : function(container){
		...
		jQuery('[name="cf_3613"], [name="cf_3629"], [name="cf_3631"], [name="cf_3633"], [name="cf_3643"], [name="cf_3625"], [name="cf_3627"], [id="CargoInsurance_Edit_fieldName_cf_3619"]').on('change', function(){
			...
			{
				 $.post('include/CargoInsurance/cargoinsurance_rate_info.php',{ insurance_type: insurance_type, assured_company: assured_company, rate_id: rate_id, special_range_id:special_range_id, total_insured_sum: total_insured_sum, discounted_glk_rate:discounted_glk_rate, mode_arr:mode_arr, departure_date: departure_date },function(data){					
