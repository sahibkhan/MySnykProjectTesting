...
{strip}
	...
	<div name='editContent'>
		...
		{if $FSL_BLACK_FLAG}
			<div class="fieldBlockContainer duplicationMessageContainer">
				<div class="duplicationMessageHeader"><b>{vtranslate('-	Please notify the name of customer to insurance team for confirmation<br>
													-	Then you can start registering insurance in ERP system under FSL Black', $MODULE)}</b></div>
		...
		{if $DISCOUNT_FLAG}
			<div class="fieldBlockContainer duplicationMessageContainer">
				<div class="duplicationMessageHeader"><b>{vtranslate('- Please insert "Discounted GLK Selling rate".', $MODULE)}</b></div>
		...
		{if $JYSANGRANT_FLAG}
			<div class="fieldBlockContainer duplicationMessageContainer">
				<div class="duplicationMessageHeader"><b>{vtranslate('-The value is above the limit. Please contact Insurance team.', $MODULE)}</b></div>
					...
					<table class="table table-borderless">
						<tr>
							...
							{foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
								{if $FIELD_NAME eq 'cf_3625'}
									<div style="color:red;font-weight: bold;" id="errmsg"></div>
								{/if}
								...
								{if $FIELD_MODEL->isEditable() eq true}
									...
									{if $FIELD_MODEL->get('uitype') neq '83'}
										...
										{if $FIELD_MODEL->get('name') eq 'cf_4559'}
											<div id="cf_4559" style="color:#F00; width:220px;"></div>
										  {/if}
										</td>									  
									{/if}
								{/if}
