					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<div style="margin-left: 50px;">
									<div>
										<select class="inputElement select2" name="Exporttype" style="width:200px !important;" >
										<option value="wis_insurance">WIS Insurance Format</option> 	
                                   		<option value="accountancy_insurance">Accountancy Insurance Format</option>
										</select>
										<label style="font-weight:normal" for="csv">&nbsp;&nbsp;Insurance Report Format</label>
									</div>
							</div>		
