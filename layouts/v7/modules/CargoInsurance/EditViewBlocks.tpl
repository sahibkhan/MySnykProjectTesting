...
<div class='container-fluid editViewContainer'>
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		{if $RECORD_ID neq ''}
            ...
            {if $FSL_BLACK_MESSAGE neq ''}
            <br />
            <font style="color:#F00;font-size:12px; font-weight:bold;">
            {$FSL_BLACK_MESSAGE}
            </font>
            {/if}
            </h3>
		...
		{/if}
			<span class="pull-right">
				{*<a href="include/CargoInsurance/WIS.php?" class="btn btn-success" type="submit" id="wis_save"><strong>{vtranslate('Save WIS', $MODULE)}</strong></a>{'&nbsp'}*}{*abay*}
