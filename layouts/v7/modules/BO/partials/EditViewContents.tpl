...
{strip}
	...
	<div name='editContent'>
		<a class="btn btn-primary" href="javascript:void(0)" id="openCalculator"   >Open Calculator</a>
									...
									<td class="fieldLabel alignMiddle">
										...
										{else}
											{if $MODULE eq 'Documents' && $FIELD_MODEL->get('label') eq 'File Name'}
												...
												{/if}
											{else}
													{if $FIELD_MODEL->get('name') eq 'cf_8726' && $USER_FROM_UKRAINE_OR_RUSSIA}
	...
	<!-- Modal --->
	<div class="modal fade" id="calculatorModal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Rate Calculator</h4>
        </div>
