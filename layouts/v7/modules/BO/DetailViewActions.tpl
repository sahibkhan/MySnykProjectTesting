    ...
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            <span class="btn-group listViewMassActions">
                <button class="btn dropdown-toggle" data-toggle="dropdown"><strong>Print BO</strong>&nbsp;&nbsp;<i class="caret"></i></button>
                <ul class="dropdown-menu">
                    <li>
                    <a href="index.php?module=BO&view=Print&template=general_en&print_type=word&record={$RECORD->getId()}"  target="_blank">  General English</a>
                    </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=general_ru&print_type=word&record={$RECORD->getId()}" target="_blank">  General Russian</a>
                    </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=appendix_en&print_type=word&record={$RECORD->getId()}"  target="_blank">  Appendix English</a>
                    </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=appendix_ru&print_type=word&record={$RECORD->getId()}" target="_blank">  Appendix Russian</a>
                    </li>

                    <li class="divider"> </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=eng_1&print_type=pdf&record={$RECORD->getId()}"  target="_blank">  General English PDF</a>
                    </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=rus_1&print_type=pdf&record={$RECORD->getId()}" target="_blank">  General Russian PDF</a>
                    </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=eng_2&print_type=pdf&record={$RECORD->getId()}"  target="_blank">  Appendix English PDF</a>
                    </li>
                    <li>
                    <a href="index.php?module=BO&view=Print&template=rus_2&print_type=pdf&record={$RECORD->getId()}" target="_blank">  Appendix Russian PDF</a>
                    </li>
                </ul>
            </span>   
