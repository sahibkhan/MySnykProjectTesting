        ...
        <div class="pull-right btn-toolbar">
            <div class="btn-group">
              ...
              <button class="btn btn-success" onclick="send_first_approval({Users_Record_Model::getCurrentUserModel()->get('id')},{$RECORD->getId()},{$RECORD->get('proc_proctype')})">Send Approval</button>
                ...
                <button class="btn btn-danger" onclick="if(confirm('Please Confirm Rejection!')) next_approval({Users_Record_Model::getCurrentUserModel()->get('id')},{$RECORD->getId()},{$RECORD->get('proc_proctype')},{$USDAMOUNT},2)" style="margin-right:5px !important;">Reject</button>
                {/if}
