...
<input type="hidden" name="proc_location" id="proc_location" value="{$locations}"/>
	...
	<input type="hidden" value="{$expensetotalrecords}" name="expensetotalrecords">
							...
							<td nowrap="" style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="qty1[]" value="{$FIELD_MODEL['quantity']}" id="qty1"/></td>
								<td nowrap="" style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="psc1[]" value="{$FIELD_MODEL['ppu']}" id="psc1" onblur="getlocalprice1('{$FIELD_MODEL['procurementitemsid']}')"/></td>
									<td nowrap="" style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="localprice[]" readonly value="{$FIELD_MODEL['local_price']}" id="localprice-apend-{$FIELD_MODEL['procurementitemsid']}"/></td>
									<td nowrap="" style="border:1px solid #D4D4D4 !important;">
										<input type="hidden" value="{$FIELD_MODEL['vat_rate']}" id="vat_original_value">
										<input class="attribute" type="text" name="VAT[]" value="{$FIELD_MODEL['vat_rate']}" id="VAT" onblur="get_currency_data('{$FIELD_MODEL['procurementitemsid']}')"/></td>
										...
										<td nowrap="" style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="gross[]" readonly value="{$FIELD_MODEL['gross']}" id="gross-apend-{$FIELD_MODEL['procurementitemsid']}"/></td>

									{if $CURRENCYDATA}
														<td nowrap="" style="border:1px solid #D4D4D4 !important;">
	<input type="hidden" id="hidden_change_currency-apend-{$FIELD_MODEL['procurementitemsid']}" value="{$FIELD_MODEL['local_currency_code']}">

															<select class="attribute select2" id="currency-apend-{$FIELD_MODEL['procurementitemsid']}" name="currency[]" onchange="get_currency_data1('apend-{$FIELD_MODEL['procurementitemsid']}')">
												...
												<td nowrap="" style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="gross_local[]" readonly value="{$FIELD_MODEL['gross_local']}" id="gross_local-apend-{$FIELD_MODEL['procurementitemsid']}"/></td>
												<td nowrap="" style="border:1px solid #D4D4D4 !important;">
													<input class="attribute" type="hidden" name="Total_local_currency_hidden" readonly id="Total_local_currency_hidden" value="0"/>
													<input class="attribute" type="text" name="Total_local_currency[]" readonly value="{$FIELD_MODEL['total_local_amount']}" id="Total_local_currency-apend-{$FIELD_MODEL['procurementitemsid']}"/></td>
													<td nowrap="" style="border:1px solid #D4D4D4 !important;"><input class="attribute" type="text" name="Total_USD[]" readonly value="{$FIELD_MODEL['total_in_usd']}" id="Total_USD-apend-{$FIELD_MODEL['procurementitemsid']}"/></td>
