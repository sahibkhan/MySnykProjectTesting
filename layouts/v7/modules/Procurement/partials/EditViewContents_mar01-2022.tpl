...
<input type="hidden" name="proc_location" id="proc_location" value="{$locations}"/>
	...
	<div name='editContent'>
		...
		{if $irrelevant_agreement_no_flag}
			<div class="fieldBlockContainer duplicationMessageContainer">
				<div class="duplicationMessageHeader"><b>{vtranslate('-	Agreement number is irrelevant. After selecting the supplier always click the refresh icon <i class="fa fa-refresh" title="Find Agreement" aria-hidden="true"></i> and then choose the Agreement No  -', $MODULE)}</b></div>
