...
$('[name="proc_proctype"]').on('change', function(){
...
$(document).ready(function(){
  ...
  $('[name="proc_department"]').attr('readonly',true);
  $('[name="proc_loc_currency"]').attr('readonly',true);
  $('[name="proc_total_amount"]').attr('readonly',true);
  $('[name="proc_currency_usd_rate"]').attr('readonly',true);
  $('[name="proc_company_status"]').attr('readonly',true);
  $('[name="proc_location"]').attr('readonly',true);
  $('[name="proc_request_no"]').attr('readonly',true);
  $('[name="proc_order_status"]').attr('readonly',true);
  $('[name="assigned_user_id"]').attr('readonly',true);
