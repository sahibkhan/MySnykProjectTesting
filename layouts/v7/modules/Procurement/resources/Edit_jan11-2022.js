...
$(document).ready(function(){
  ...
  $("#proc_supplier_display").closest( "td" ).append('<br><i class="fa fa-refresh" title="Find Agreement" aria-hidden="true" id="searchagreement"></i>');
	$("#Procurement_editView_fieldName_proc_agreement_no").closest( "td" ).html('<select name="proc_agreement_no" class="select2 agreementdropdown" style="width:75%"><option value="">Select Option</option></select>');
