				...
				<div class="datacontent row">
					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<br><div><b>{vtranslate('LBL_EXPORT_DATA',$MODULE)}</b></div>
							<br>
							<!-- custom dropdown start from here-->
								<div style="margin-left: 50px;">
										<div>
											<label style="font-weight:normal" for="csv">&nbsp;&nbsp;Report Format</label>

											<select class="inputElement select2" name="Exporttype" style="width:500px !important;" >
