			...
			<div class="col-lg-5 col-md-5 pull-right">
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
						{if $MODULE_MODEL->isReportAccessible()}
							<li>
								<button  data-toggle="modal" data-target="#ResignationReportModal" class="btn addButton btn-default module-buttons" target="_blank">
