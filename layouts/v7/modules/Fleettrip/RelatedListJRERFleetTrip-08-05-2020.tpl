...
{strip}
	...
	<div class="relatedContainer">
		...
		<div class="relatedContents col-lg-12 col-md-12 col-sm-12 table-container">
			<div class="bottomscroll-div" style="min-height:550px">
				<table class="table listview-table" id="list">
				<tr><td ></td></tr>
				</table>
                 <div id="pager"></div>
...
$grid.jqGrid('gridResize');
	...
	$("#PaymentVoucherButton").click( function() {
	   ...
	   {	
		   ...
		   $.ajax({
					url: 'include/Jobexpencereport/send_to_head_of_department.php?job_id='+{/literal}{$FLEET_TRIP_ID}{literal}+'&role='+role+'&expenseids='+rowId,
					success: function(data){
					   //var result=JSON.parse(data);
					window.location='index.php?module=Fleettrip&relatedModule=Jobexpencereport&view=Detail&record='+{/literal}{$FLEET_TRIP_ID}{literal}+'&mode=showRelatedList&tab_label=Fleet%20Expense';
