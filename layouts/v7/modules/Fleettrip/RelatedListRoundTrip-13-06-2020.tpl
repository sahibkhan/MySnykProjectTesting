                    ...
                    <table class="table listview-table" id="listview-table" >
                      ...
                      <tbody>
                       {foreach item=PROFIT from=$PROFIT_SHARE}                     
                        ...
                        <td class="relatedListEntryValues"><a href="SubJCR_export_pdf.php?record={$PROFIT['job_id']}&userid={$PROFIT['user_id']}" target="_blank" title=""><i class="fa fa-print alignMiddle" title="Job File Sub JCR"></i></a></td>
                        </tr>
                         {/foreach} 
                      </tbody>
                       <thead>
