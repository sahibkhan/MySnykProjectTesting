	...
	public function print_pm_requisitions($request)
	{
		...
		foreach($models_1 as $key => $model){
			...
			$pm_items .='<tr>
						...
						<td>'.$pmitem_info->getDisplayValue('cf_6054').'</td>
						<td>'.$pmitem_info->getDisplayValue('cf_6056').'</td>
						<td>'.$pmitem_info->getDisplayValue('cf_6058').'</td>
						<td>'.$pmitem_info->getDisplayValue('cf_6060').'</td>
						</tr>';
		}
