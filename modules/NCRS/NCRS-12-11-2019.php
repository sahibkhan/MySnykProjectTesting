...
class NCRS extends Vtiger_CRMEntity {
	...
	function notification_NCR($recordId,$module, $action){
		...
		if($action=='Pending'){			
			...
			$body .="<p>As per your request, we initiated NCR against ".$raised_for_first_name." ".$raised_for_last_time." / ".$for_department." ".$for_location.".<br />";
		...
		elseif($action=='Approved')
		{
			...
			$body .="<p>Thanks for initiating NCR against ".$raised_for_first_name." ".$raised_for_last_time."  ".$for_department." / ".$for_location.".<br />";
