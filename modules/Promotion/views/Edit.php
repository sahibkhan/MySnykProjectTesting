...
Class Promotion_Edit_View extends Vtiger_Edit_View {
  ...
  if(!empty($record) && $request->get('isDuplicate') == true) {
    ...
    if(empty($record)){
      if($request->get('returnmodule') == 'UserList' && $request->get('returnrecord')) {
        ...
        $promotionRequest = Vtiger_Record_Model::getInstanceById($sourceRecord, $sourceModule);
...
/*         $currentUserModel = Vtiger_Record_Model::getInstanceById($currentUserId, 'Users');
        ...
        $request->set('assigned_user_id', $currentUserId); // Requested By
  
        $request->set('cf_7420', $promotionRequest->get('cf_3349')); // Department   
        $request->set('cf_7446', $promotionRequest->get('cf_3421')); // Location

        $request->set('cf_7864', $promotionRequest->get('cf_823')); // Current Position   
      }
