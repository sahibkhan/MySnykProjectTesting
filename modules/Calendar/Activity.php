...
class Activity extends CRMEntity {
	...
	function save_module($module)
	{
		...
		if(isset($this->column_fields['parent_id']) && $this->column_fields['parent_id'] != ''){
			...
			$account_id = $this->column_fields['parent_id'];
			$customer_business =  $this->db->sql_escape_string($this->column_fields['cf_6566']);
			$headoffice =  $this->db->sql_escape_string($this->column_fields['cf_6568']);
			$customer_logistics_requirement =  $this->db->sql_escape_string($this->column_fields['cf_6570']);	

			$customer_rfq_system =  $this->db->sql_escape_string($this->column_fields['cf_6590']);
			$Preferred_Logistics_Partner =  $this->db->sql_escape_string($this->column_fields['cf_6592']);
			$existing_cooperation =  $this->db->sql_escape_string($this->column_fields['cf_6594']);
		
			$future_business =  $this->db->sql_escape_string($this->column_fields['cf_6596']);
			$last_updated =  $this->db->sql_escape_string($this->column_fields['cf_6598']);
			$comments =  $this->db->sql_escape_string($this->column_fields['cf_6600']);
		

			$sql = "UPDATE vtiger_accountscf 
					SET cf_6572 = '$customer_business', 
					cf_6574 = '$headoffice',
					cf_6576 = '$customer_logistics_requirement',

					cf_6578 = '$customer_rfq_system',
					cf_6580 = '$Preferred_Logistics_Partner',
					cf_6582 = '$existing_cooperation',
					
					cf_6584 = '$future_business',
					cf_6586 = '$last_updated',
					cf_6588 = '$comments'
