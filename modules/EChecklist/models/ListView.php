 ...
 */
class EChecklist_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
		...
		//echo $listQuery."<br><pre>"; print_r($paramArray);echo "</pre>";exit;
		$listResult = $db->pquery($listQuery, $paramArray);
		//echo "<br><pre>"; print_r($listResult);echo "</pre>";exit;
		...
		//echo "<pre>"; print_r($listViewEntries);echo "</pre>";exit;
		$index = 0;
