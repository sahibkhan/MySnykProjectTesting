...
class Job_List_View extends Vtiger_Index_View {
	...
	function __construct() {
		...
		//$adb->setDebug(true);
		parent::__construct();
		$this->exposeMethod('record_1c_upload');
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		$searchAndTagParams = $searchParams;
		...
		*/
		...
		$viewer->assign('TAG_DETAILS', array());
	...
	function record_1c_upload(Vtiger_Request $request){
		...
		include(dirname(__FILE__)."/../../../include/Exchangerate/exchange_rate_class.php");
		global $adb;
		...
		foreach($recordArray as $record){
			...
			*/
			...
			$web1C = 'http://89.218.38.221/gl/ws/CreateJobFile?wsdl'; 
			$con1C = array( 'login' => 'AmdWS', //AdmWS Live
							'password' => '906900', //6fc@t\Vy Live
