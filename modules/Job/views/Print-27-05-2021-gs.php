					...
					<table class="pdf-content-table">
						<tbody>
							<tr>
								...
								<td class="pdf-td-value">'.$customer.'</td>
							</tr>
							<tr>
								<td class="pdf-td-title">From:</td>
								<td class="pdf-td-value">'.$job_info_detail->get('cf_1072').'</td>
							</tr>
							<tr>
								<td class="pdf-td-title">To:</td>
								<td class="pdf-td-value">'.$job_info_detail->get('cf_1074').'</td>
							</tr>
							<tr>
								<td class="pdf-td-title">Mode:</td>
								<td class="pdf-td-value">'.$mode.'</td>
							</tr>
							<tr>
