		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			if(empty($record))
			{
				...
				elseif($request->get('returnmodule') == 'Quotes' && $request->get('returnrecord')) {
					...
					$request->set('cf_1516', $quote_info->get('cf_1625')); //expected_date_of_loading
					$request->set('cf_1583', $quote_info->get('cf_1627')); //expected_date_of_delivery
					$request->set('cf_1589', $quote_info->get('cf_1629')); //etd
					$request->set('cf_1591', $quote_info->get('cf_1631')); //eta
