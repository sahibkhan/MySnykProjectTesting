		...
		elseif($relatedModuleName == 'Jobexpencereport')
		{
			...
			if($count_parent_role>3)
			{
				...
				{					
					...
					$selling_field_invoice[] = array('name' => 'tax_invoice_no', "align" => "center", 'width'=>'80', 'frozen'=>true);
					...
					$selling_field_invoice[] = array('name' => 'local_tax_invoice_no', "align" => "center", 'width'=>'120', 'sortable' =>'false',
													 'editable' => true, 'edittype' => 'textarea', 'editoptions' => array('rows'=>'3', 'cols' => '12'));
					...
					*/
					$selling_field_invoice[] = array('name' => 'check_invoice_tax', "align" => "center", 'width'=>'80');
