...
Class ProjectCargoCheckList_Edit_View extends Vtiger_Edit_View {
	...
	function preProcess(Vtiger_Request $request, $display=true) { 
		...
		$OVERLAP_date_flag  = false;
		$OVERLAP_date_msg  = "";
		$overlap_date = $request->get('overlap_date');

		if(isset($overlap_date) && $overlap_date==true){
			$OVERLAP_date_flag  = true;
			$OVERLAP_date_msg  = $request->get('overlap_msg');	
		}
