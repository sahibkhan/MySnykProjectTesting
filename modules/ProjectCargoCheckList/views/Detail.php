...
class ProjectCargoCheckList_Detail_View extends Vtiger_Detail_View {
	...
	public function getUserData(Vtiger_Request $request) {
		...
		if ($requestedById > 0){
			...
			// Current Position
			// $userData['currentPositionId'] = $recordModel->get('cf_3349');	
		}
	...
	function showModuleDetailView(Vtiger_Request $request) {
		...
		where vtiger_crmentity.crmid=".$recordId;
		...
		global $adb;
		$doc="SELECT 
		vtiger_projectcargochecklistcf.clone_doc_liability_crg AS vtiger_projectcargochecklistcfclone_doc_liability_crg,
		vtiger_projectcargochecklistcf.clone_doc_ins_globalink_crg AS vtiger_projectcargochecklistcfclone_doc_ins_globalink_crg,
		vtiger_projectcargochecklistcf.clone_doc_ins_customer_crg AS vtiger_projectcargochecklistcfclone_doc_ins_customer_crg,
		vtiger_projectcargochecklistcf.clone_doc_rigging_ins_crg AS vtiger_projectcargochecklistcfclone_doc_rigging_ins_crg,
		vtiger_projectcargochecklistcf.clone_doc_loading_plan_crg AS vtiger_projectcargochecklistcfclone_doc_loading_plan_crg,
		vtiger_projectcargochecklistcf.clone_doc_obstacles_crg AS vtiger_projectcargochecklistcfclone_doc_obstacles_crg,
		vtiger_projectcargochecklistcf.clone_doc_lifting_plan_crg AS vtiger_projectcargochecklistcfclone_doc_lifting_plan_crg,
		vtiger_projectcargochecklistcf.clone_doc_road_permit_crg AS vtiger_projectcargochecklistcfclone_doc_road_permit_crg,
		vtiger_projectcargochecklistcf.clone_doc_pilot_cars_crg AS vtiger_projectcargochecklistcfclone_doc_pilot_cars_crg,
		vtiger_projectcargochecklistcf.clone_doc_civil_works_crg AS vtiger_projectcargochecklistcfclone_doc_civil_works_crg
		FROM vtiger_crmentity 
		LEFT JOIN vtiger_projectcargochecklist ON (vtiger_projectcargochecklist.projectcargochecklistid = vtiger_crmentity.crmid ) 
		LEFT JOIN vtiger_projectcargochecklistcf ON (vtiger_projectcargochecklistcf.projectcargochecklistid = vtiger_crmentity.crmid ) 
		LEFT JOIN vtiger_crmentity_user_field ON (vtiger_crmentity_user_field.recordid = vtiger_crmentity.crmid AND vtiger_crmentity_user_field.userid = 1 ) 
					WHERE vtiger_crmentity.crmid="."$recordId"."
					LIMIT 1
					";
				$doc = $adb->pquery($doc,array());
				$docs = array();
				for($j=0; $j<$adb->num_rows($doc); $j++) {
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_liability_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_liability_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_ins_globalink_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_ins_globalink_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_ins_customer_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_ins_customer_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_rigging_ins_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_rigging_ins_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_loading_plan_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_loading_plan_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_obstacles_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_obstacles_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_lifting_plan_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_lifting_plan_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_road_permit_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_road_permit_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_pilot_cars_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_pilot_cars_crg');
					$docs[$j]['vtiger_projectcargochecklistcfclone_doc_civil_works_crg'] = $adb->query_result($doc, $j, 'vtiger_projectcargochecklistcfclone_doc_civil_works_crg');
		...
		$path1 = $recordModel->get('doc_liability_crg_path');
		$viewer->assign('FILEPATH1', $path1);
		$path2 = $recordModel->get('doc_ins_globalink_crg_path');
		$viewer->assign('FILEPATH2', $path2);
		$path3 = $recordModel->get('doc_ins_customer_crg_path');
		$viewer->assign('FILEPATH3', $path3);
		$path4 = $recordModel->get('doc_rigging_ins_crg_path');
		$viewer->assign('FILEPATH4', $path4);
		$path5 = $recordModel->get('doc_loading_plan_crg_path');
		$viewer->assign('FILEPATH5', $path5);
		$path6 = $recordModel->get('doc_lifting_plan_crg_path');
		$viewer->assign('FILEPATH6', $path6);
		$path7 = $recordModel->get('doc_obstacles_crg_path');
		$viewer->assign('FILEPATH7', $path7);
		$path8 = $recordModel->get('doc_road_permit_crg_path');
		$viewer->assign('FILEPATH8', $path8);
		$path9 = $recordModel->get('doc_pilot_cars_crg_path');
		$viewer->assign('FILEPATH9', $path9);
		$path10 = $recordModel->get('doc_civil_works_crg_path');
		$viewer->assign('FILEPATH10', $path10);
