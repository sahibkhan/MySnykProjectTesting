...
class ProjectCargoCheckList_AccountsPopup_View extends Vtiger_Popup_View {
	...
	function process (Vtiger_Request $request) {
		...
		$moduleName = 'ProjectCargoCheckList';
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		$viewer->assign('VIEW', 'AccountsPopup');
	}
	...
	function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array('modules.ProjectCargoCheckList.resources.Popup');
