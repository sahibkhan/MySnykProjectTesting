...
class ProjectCargoCheckList_Save_Action extends Vtiger_Save_Action {
    ...
    public function process(Vtiger_Request $request) {
        ...
        $allowTypes = array('jpg', 'JPG', 'jpeg', 'JPEG', 'png', 'PNG', 'gif', 'GIF', 'pdf', 'PDF', 'xlsx', 'XLSX', 'docx', 'DOCX');
        try {
            ...
            if ($record_id) {
                ...
                if (!empty($fileName1)) {
                    if (in_array($validatefile1, $allowTypes)) {
                        ...
                        throw new FormatException('- The File Formats you are trying to Upload Not Allowed !');
                    }
                }
                if (!empty($fileName2)) {
            ...
            $requestData['type_msg'] = $e->getMessage();
