...
// print_r($request);exit;
		...
		$items_missing_flag  = false;
		$items_missing = $request->get('items_missing');
		if(isset($items_missing) && $items_missing==true){
			$items_missing_flag  = true;
		}
		$viewer->assign('items_missing_flag', $items_missing_flag);
		$irrelevant_agreement_no_flag  = false;
		$irrelevant_agreement_no = $request->get('irrelevant_agreement_no');
		if(isset($irrelevant_agreement_no) && $irrelevant_agreement_no==true){
			$irrelevant_agreement_no_flag  = true;
		}
		$viewer->assign('irrelevant_agreement_no_flag', $irrelevant_agreement_no_flag);
