 ...
 */
class Procurement_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
		...
		$listQuery = str_replace("vtiger_crmentityproc_title.label","vtiger_procurementcf.proc_title",$listQuery);
		$listQuery = str_replace("vtiger_crmentityproc_location.label","vtiger_procurementcf.proc_location",$listQuery);
		$listQuery = str_replace("vtiger_crmentityproc_department.label","vtiger_procurementcf.proc_department",$listQuery);
		//echo $listQuery;exit;
		/* if($this->module == 'Procurement') 
			{ 
		...
		foreach($listViewEntries as $recordId => $record) {
			...
			$module_data = Vtiger_Record_Model::getInstanceById($recordId);
			$requested_item_module_data = $this->module_data?$this->module_data:Vtiger_Record_Model::getInstanceById($module_data->get('proc_proctype'), 'ProcurementTypes');
			$Reqesteditemname = $requested_item_module_data->get('name');
			$listViewRecordModels[$recordId]->set('proc_proctype',$Reqesteditemname);
