 ...
 */
class Procurement_Module_Model extends Vtiger_Module_Model {
	...
	public function getFields($blockInstance=false) {
		if(empty($this->fields)){
			...
			$this->fields = array();
			//echo "<pre>";print_r($moduleBlockFields);echo "</pre>";exit;
	...
	public static function getInstance($value) {
		...
		//echo "yes <pre>";print_r($instance);exit;
		return $instance;
	}
...
//						3 => 'LBL_PREFER_VTIGER_RECORD',
	...
	public function getModuleIcon() {
		...
		$submenu_icon = 'vicon-'.$lowerModuleName;

		$fa_icon_array = array('job', 'fleetinquiry','fleettrip','trucktracking','triptemplates','truckservice','truck','trucktypes',
								'driverlicense','wagontrip', 'waggontracker', 'wagontriptemplate','wagonrate','wagon',
								'surveyinquiry','survey','overtime','overtimerates','room','dictionary',
								'deductiblerate','specialrange','commodityrates','commoditytype','masterprofiles','salesplan',
								'userattendance','leaverequest','ncrs','countryholidays','training',
								'pmrequisitions','itequipment','furniturerequest','qhserequsition','truckparts','quickit',
								'dwcexpense','itemtrxmaster','whitemqtymaster','whitemmaster','warehousemaster','whuom','fslblack',
								'cargoinsurance','invoiceglk','deliveryreport','damagereport','alerts',
								'packerinquiry','rrspackerscrew','pmtype',
								'businesscard','truckinsurance','companyinsurance','insuranceclaim','rrsinsurance','serviceagreement',
								'bo','vpo','legalcases','itequipment','furniturerequest','qhserequsition','truckparts','quickit','dwcexpense'
								,'employeecv','tripaddresses','triplistfuel','railwayfleet','performanceappraisal','staffhiring');


		if(in_array($lowerModuleName, $fa_icon_array))
		{
			$submenu_icon = 'fa fa-'.$lowerModuleName;
		}

		//$moduleIcon = "<i class='vicon-$lowerModuleName' title='$title'></i>";
		$moduleIcon = "<i class='$submenu_icon' title='$title'  ></i>";
