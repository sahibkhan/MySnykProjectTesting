...
if($page == 'get_request_number'){ //for transaction (ItemTRXMaster) module
    ...
    $pm_request_query = 'SELECT vtiger_procurement.procurementid, vtiger_procurement.requesteditem,  vtiger_procurementcf.proc_request_no as request_no FROM vtiger_procurement
