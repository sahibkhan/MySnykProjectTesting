...
class Procurement_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		$localtotal = $request->get('proc_loc_currency');
		$dollartotal = $request->get('proc_total_amount');


		$id = $request->get('sourceRecord');
		$module = $request->get('sourceModule');
		$info = Vtiger_Record_Model::getInstanceById($id, $module);
