...
class Procurement_BasicAjax_Action extends Vtiger_BasicAjax_Action {
    ...
    public function process(Vtiger_Request $request) {
        ...
        $searchModule = $request->get('search_module'); //Accounts
		
        $parentRecordId = $request->get('parent_id');
        $parentModuleName = $request->get('parent_module');
        $relatedModule = $request->get('module'); //Procurement
