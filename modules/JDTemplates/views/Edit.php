...
Class JDTemplates_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->assign('USER_LANG', ($_REQUEST['lang'] == 'ru') ? 'ru' : '');

		$blockNamesRu = array(
			'LBL_JDTEMPLATES_INFORMATION' => 'LBL_JDTEMPLATES_INFORMATION_RU',
			'LBL_CUSTOM_INFORMATION' => 'LBL_CUSTOM_INFORMATION_RU',
			'Minimum Requirements' => 'Minimum Requirements_RU'
		);

		$fieldNamesRu = array(			
			'Name' => 'Name_ru',
			'Assigned To' => 'Assigned To_ru',
			'Location' => 'Location_ru',
			'Department' => 'Department_ru',
			'Position' => 'Position_ru',
			
			'Legal Entity' => 'Legal_Entity_ru',
			'Job Purpose' => 'Job_Purpose_ru',
			'Internal Contacts' => 'Internal_Contacts_ru',
			'External Contacts' => 'External_Contacts_ru',
			'Non-Financial' => 'Financial_ru',
			'Organizational Chart' => 'Organizational_Chart_ru',
			'Financial if any' => 'Financial_if_any_ru',
		
			'Education' => 'Education_ru',
			'Work Experience' => 'Work_Experience_ru',
			'Language Skills' => 'Language_Skills_ru',
			'Specific Knowledge' => 'Specific_Knowledge_ru',
			'Business Understanding' => 'Business_Understanding_ru',
			'Key Account-abilities' => 'Key_Account-abilities_ru',
			'Main Responsibilities' => 'Main Responsibilities_ru'
		);
		$viewer->assign('FIELD_NAMES_RU', $fieldNamesRu);
		$viewer->assign('BLOCK_NAMES_RU', $blockNamesRu);
