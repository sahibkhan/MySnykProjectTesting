...
Class HandOverList_Edit_View extends Vtiger_Edit_View {
  ...
  if(!empty($record) && $request->get('isDuplicate') == true) {
    ...
    {	
      if($request->get('returnmodule') == 'Resignation' && $request->get('returnrecord')) 
      {
        ...
        $request->set('cf_7500', $userList->get('cf_7452')); // Location
        $request->set('cf_7502', $userList->get('cf_7454')); // Department 
        // $request->set('cf_7232', $job_info->get('cf_7296')); // Position
        // $request->set('assigned_user_id', $userList->get('assigned_user_id')); // Assigned to
