 ...
 */
        ...
        $event_status = detect_message_status_p($record);
        ...
        $arranged_details = arrange_inqfetch_details($record,$assigned_users,$route_details,$cargo_details,$all_field_details,$event_status);	
        ...
        send_inq_notification($creator_email,$creator_name,$who_updated_email,$who_updated_name,$module,$record,$subject,$message_status,$arranged_details,$cc,$event_status);
    ...
    function send_inq_notification($creator_email,$creator_name,$who_updated_email,$who_updated_name,$module,$record,$subject,$message_status,$sum,$cc,$event_status){
      ...
      function control_emails_sending($to,$cc,$from,$subject,$body,$headers,$link,$record){
        ...
        $from_user_city = get_vtiger_user_details_($trimed_from,'email1','address_city');
        if ($from_user_city == 'Baku')    $conflict_baku = 1;
        if ($from_user_city == 'Yerevan') $conflict_erevan = 1;
        
                                            // Checking in specific person
        $from_user_login = get_vtiger_user_details_($trimed_from,'email1','user_name');
        ...
        //$from_user_login = '';
        //$trimed_to = trim($to);
        //$to_user_city = get_vtiger_user_details_($trimed_to,'email1','address_city');
        //if ($to_user_city == 'Baku')    $conflict_baku = 1;
        //if ($to_user_city == 'Yerevan') $conflict_erevan = 1;
        
                                            // Checking in specific person
        $from_user_login = get_vtiger_user_details_($trimed_to,'email1','user_name');
        //if ($from_user_login == 'r.tumanyan') $conflict_erevan = 1;
        //if ($from_user_login == 'p.karim') $conflict_erevan = 1;
        ...
        if ($n > 0){
            for($i = 0; $i <= $n; $i++){
                ...
                $cc_user_city = get_vtiger_user_details_($trimed_to,'email1','address_city');
    ...
    function get_vtiger_user_details_($value,$require_field,$field){
        $adb = PearDatabase::getInstance();
    ...
    function get_inquiry_history($record,$history_field){
