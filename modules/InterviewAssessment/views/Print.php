...
class InterviewAssessment_Print_View extends Vtiger_Print_View {
	...
	function process (Vtiger_Request $request)	{
		...
		$this->setValue('age', $InterviewAssessment_info->getDisplayValue('cf_7174'), ENT_QUOTES, "UTF-8");
		$this->setValue('position', $InterviewAssessment_info->getDisplayValue('cf_7176'), ENT_QUOTES, "UTF-8");

		$this->setValue('department', $InterviewAssessment_info->getDisplayValue('cf_7180'), ENT_QUOTES, "UTF-8");
		$this->setValue('location', $InterviewAssessment_info->getDisplayValue('cf_7182'), ENT_QUOTES, "UTF-8");
		$this->setValue('type', $InterviewAssessment_info->getDisplayValue('cf_7178'), ENT_QUOTES, "UTF-8");
		$this->setValue('education', $InterviewAssessment_info->getDisplayValue('cf_7188'), ENT_QUOTES, "UTF-8");

		$this->setValue('workexperience', $InterviewAssessment_info->getDisplayValue('cf_7192'), ENT_QUOTES, "UTF-8");
		$this->setValue('communication', $InterviewAssessment_info->getDisplayValue('cf_7190'), ENT_QUOTES, "UTF-8");
		// $this->setValue('language', $InterviewAssessment_info->getDisplayValue('cf_7244'), ENT_QUOTES, "UTF-8");
		$this->setValue('leadership', $InterviewAssessment_info->getDisplayValue('cf_7194'), ENT_QUOTES, "UTF-8");

		$this->setValue('strength', $InterviewAssessment_info->getDisplayValue('cf_7210'), ENT_QUOTES, "UTF-8");
		$this->setValue('weekness', $InterviewAssessment_info->getDisplayValue('cf_7208'), ENT_QUOTES, "UTF-8");

		$this->setValue('presentsalary', $InterviewAssessment_info->getDisplayValue('cf_7214'), ENT_QUOTES, "UTF-8");
		$this->setValue('expectedsalary', $InterviewAssessment_info->getDisplayValue('cf_7212'), ENT_QUOTES, "UTF-8");

		$this->setValue('availability', $InterviewAssessment_info->getDisplayValue('cf_7216'), ENT_QUOTES, "UTF-8");
		
		$interview_result = $InterviewAssessment_info->getDisplayValue('cf_7218');
		...
		$this->setValue('interview_result', $InterviewAssessment_info->getDisplayValue('cf_7218'), ENT_QUOTES, "UTF-8");
		$this->setValue('source', $InterviewAssessment_info->getDisplayValue('cf_7254'), ENT_QUOTES, "UTF-8");
		$this->setValue('opinion_referees', $InterviewAssessment_info->getDisplayValue('cf_7256'), ENT_QUOTES, "UTF-8");
		// $this->setValue('interviewers', $InterviewAssessment_info->getDisplayValue('cf_7224'), ENT_QUOTES, "UTF-8");
		

		$inviteUserList = $this->getInviteUsers($record);
		$this->setValue('interviewers', $inviteUserList, ENT_QUOTES, "UTF-8");

		$interview_type = $InterviewAssessment_info->getDisplayValue('cf_7228');
		if($interview_type == "Personal"){
		$this->setValue('interview_personal', "checked='True'", ENT_QUOTES, "UTF-8");}
		elseif($interview_type == "Primary Phone"){
		...
		$this->setValue('date', $InterviewAssessment_info->getDisplayValue('cf_7226'), ENT_QUOTES, "UTF-8");
		$education = $InterviewAssessment_info->getDisplayValue('cf_7198');
		$edu_rating = "";
		for($i=5;$i>=1;$i--)
		{
		...
		$workexperience = $InterviewAssessment_info->getDisplayValue('cf_7200');
		$work_rating = "";
		for($i=5;$i>=1;$i--)
		{
		...
		$communication = $InterviewAssessment_info->getDisplayValue('cf_7202');
		...
		$languages = $InterviewAssessment_info->getDisplayValue('cf_7196');
		$language_rating = '';
		// Russian:5;English:4;
		...
		$leadership = $InterviewAssessment_info->getDisplayValue('cf_7204');
		$leadership_rating = "";
		for($i=5;$i>=1;$i--)
		{
	...
	public function getInviteUsers($recordId){
		global $adb;
