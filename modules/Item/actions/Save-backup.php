	...
	public function checkPermission(Vtiger_Request $request) {
		...
		if($recordId && !$request->get('relationOperation'))
		{
			...
			if ($db->num_rows($result)) 
			{
				...
				$db->pquery('UPDATE vtiger_surveycf SET cf_3897 = ?, cf_3899 = ?, cf_3893 = ?, cf_3895 = ? WHERE
					surveyid = ?', array($cf_3897, $cf_3899, $cf_3893, $cf_3895, $parentRecordId));
