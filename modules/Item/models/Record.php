...
class Item_Record_Model extends Vtiger_Record_Model {
	...
	public function getImageDetails() {
		...
		if ($recordId) {
				$sql = "SELECT vtiger_attachments.*, vtiger_crmentity.setype FROM vtiger_attachments
						...
						WHERE vtiger_crmentity.setype = 'Item Attachment' AND vtiger_seattachmentsrel.crmid = ?";
	...
	public function delete() {
		...
		$sql = mysql_query("UPDATE `vtiger_itemcf` SET `cf_6404` = '$date' WHERE `itemid` = $record");
