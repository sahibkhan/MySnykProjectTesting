...
class PMItems_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		$result['_recordId'] = $recordModel->getId();
			...
			mysql_query("update vtiger_pmrequisitionscf set cf_4593='Pending' WHERE cf_4593='Submitted' AND pmrequisitionsid='".$pmrequisitions_id."' ");
		}
		...
		$field_name_arr = array('374' => array('approved_by' => 'cf_4589', 'approved_date' =>'cf_4591'),
								'374' => array('approved_by' => 'cf_4581', 'approved_date' =>'cf_4583')
								);
		//echo "<pre>";
		...
		$ceo_approval_info = Users_Record_Model::getInstanceById(374, 'Users');
		...
		if($total_cost_in_usd>=5000)
		{
		 ...
		 $owner_email1   = $current_user_info->get('email1');
		  ...
		  $body .= "<tr><td colspan=2>Request for Packing ID: $pmrequisitions_id from : $created_by_name / $department / $location </td></tr>";
		  ...
		  $body .= "<tr><td colspan=2>RRS Signature: $rrs_signature, Date:$rrs_signature_date</td></tr>";
		  $body .= "<tr><td colspan=2>CFO Signature: $fd_signature, Date:$fd_signature_date</td></tr>";
		  $body .= "<tr><td colspan=2>Please see details on this link: <a href='$link'> Link to new Packing request </a></td></tr>";
