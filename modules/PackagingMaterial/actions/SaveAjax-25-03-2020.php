...
class PackagingMaterial_SaveAjax_Action extends Vtiger_SaveAjax_Action {

	public function process(Vtiger_Request $request) {
		
		$request->set('cf_6124', 'Requested');
		
		$item_code = $request->get('cf_5738');
		$request->set('cf_6290','No');
		if($item_code=="SR-1" || $item_code=="SL-1")
		{
			$request->set('cf_6290','Yes');
		}
