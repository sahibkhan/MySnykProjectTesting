			 ...
			 if(!in_array($packaging_ref_no, $check_packaging_ref_no) && $PackagingMaterial_info->get('cf_6124')=='Received' && !empty($job_ref_no))
			 {
				...
				try {
					  ...
					  {					 			  
						...
						$mailto = 's.mehtab@globalinklogistics.com'; //Mailto here
						$from_name = 'ACME Corps Ltd'; //Name of sender mail
						$from_mail = 'r.gusseinov@globalinklogistics.com'; //Mailfrom here
						$to = "s.mehtab@globalinklogistics.com";
						$from = "Website <r.gusseinov@globalinklogistics.com>";
						...
						echo 'Successf_'.date('Y-m-d');
						exit;	
							
							$body = '';
						
						$body .="<p>Dear&nbsp; ".$PackagingMaterial_user_info->get('first_name').",</p>";
						$body .="<p>Below Item list issued from warehouse for job file ".$job_ref_no.".</p>";
						...
						$body .="<br>Packaging Material Items Details.<br>";
