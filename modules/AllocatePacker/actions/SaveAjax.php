...
class AllocatePacker_SaveAjax_Action extends Vtiger_SaveAjax_Action {

	public function process(Vtiger_Request $request) {

		$list_packer = $request->get('cf_5345');
		$list_packer = implode(' |##| ',$list_packer);
		$request->set('cf_5345',$list_packer);
