 ...
 */
class ProcurementApproval_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
		...
		foreach($listViewEntries as $recordId => $record) {
			...
			$requested_item_module_data = $this->module_data?$this->module_data:Vtiger_Record_Model::getInstanceById($module_data->get('procapproval_proctype'), 'ProcurementTypes');
			$Reqesteditemname = $requested_item_module_data->get('name');
			$listViewRecordModels[$recordId]->set('procapproval_proctype',$Reqesteditemname);
