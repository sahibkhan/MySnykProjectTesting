...
Class ProcurementApproval_Edit_View extends Vtiger_Edit_View {
  ...
  $approvallist[$i]['procurementtypesid'] = $db->query_result($result, $i, 'procurementtypesid');
	$approvallist[$i]['name'] = $db->query_result($result, $i, 'name');
	}
	// echo "<pre>";
	// print_r ($approvallist);exit;
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			$recordModel = $this->record?$this->record:Vtiger_Record_Model::getInstanceById($record, $moduleName);
			$checklist_dropdown = $recordModel->get('procapproval_proctype');
		...
		$viewer->assign('ITEMDATAID', $checklist_dropdown);
		$viewer->assign('CURRENTDATE', date('Y-n-j'));
		$viewer->assign('USER_MODEL', Users_Record_Model::getCurrentUserModel());

		$viewer->assign('ITEMDATA', $approvallist);
