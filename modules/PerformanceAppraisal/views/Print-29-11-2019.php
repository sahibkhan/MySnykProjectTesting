...
class PerformanceAppraisal_Print_View extends Vtiger_Print_View {
 ...
 function process(Vtiger_Request $request) {  
  ...
  public function print_performance_appraisal($request) {
    ...
    $document = $this->loadTemplate('printtemplates/HR/performanceappraisal.html');
    ...
    foreach($final_appraisal_arr as $key => $appraisal_cat)
    {
       ...
       {
        $appraisal_html .='<td style="vertical-align: top;"><b>'.$question['sub_cat_eng'].'</b><br>
                            - '.$question['question_name_eng'].'
                            </td>';
        $APPRAISAL_LEVEL =$question['level'];                    
        $appraisal_html .='<td style="vertical-align: top;text-align: center;"><input type="checkbox" '.(($question['question_answer_value']==8) ? 'checked="checked"' : '').' ><br>'.$APPRAISAL_LEVEL['Excellent']['level_ans_eng'].'</td> 
				                   <td style="vertical-align: top;text-align: center;"><input type="checkbox" '.(($question['question_answer_value']==7) ? 'checked="checked"' : '').'  ><br>'.$APPRAISAL_LEVEL['Outstanding']['level_ans_eng'].'</td> 
				                   <td style="vertical-align: top;text-align: center;"><input type="checkbox"  '.(($question['question_answer_value']==6) ? 'checked="checked"' : '').' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" '.(($question['question_answer_value']==5) ? 'checked="checked"' : '').'  ><br>'.$APPRAISAL_LEVEL['Good']['level_ans_eng'].'</td>  
				                   <td style="vertical-align: top;text-align: center;"><input type="checkbox" '.(($question['question_answer_value']==4) ? 'checked="checked"' : '').'  ><br>'.$APPRAISAL_LEVEL['Average']['level_ans_eng'].'</td>
				                   <td style="vertical-align: top;text-align: center;"><input type="checkbox"  '.(($question['question_answer_value']==3) ? 'checked="checked"' : '').' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" '.(($question['question_answer_value']==2) ? 'checked="checked"' : '').' ><br>'.$APPRAISAL_LEVEL['Improvement_Needed']['level_ans_eng'].'</td> 
				                   <td style="vertical-align: top;text-align: center;" ><input type="checkbox"  '.(($question['question_answer_value']==1) ? 'checked="checked"' : '').' ><br>'.$APPRAISAL_LEVEL['Poor']['level_ans_eng'].'<br>
                           </td>';
