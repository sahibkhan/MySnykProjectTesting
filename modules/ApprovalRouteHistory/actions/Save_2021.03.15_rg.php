...
/* 	echo 'motiwid = ' . $motiwid;
	...
	$sql_a = "SELECT  * FROM vtiger_approvalroutehistorycf 
											INNER JOIN vtiger_crmentity ON vtiger_crmentity.crmid = vtiger_approvalroutehistorycf.approvalroutehistoryid WHERE vtiger_crmentity.deleted=0 AND vtiger_approvalroutehistorycf.cf_6784 ='".$motiwid."' AND vtiger_approvalroutehistorycf.cf_6788 = '".$current_user_id."' AND cf_6792 = 'inline'"; 
...
/* 		
					...
					if ($motiwid > 0 && $currentUserModel->get('id') == 1122){
