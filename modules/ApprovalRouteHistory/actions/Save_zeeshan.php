 ...
 * All Rights Reserved.
 *************************************************************************************/
class AprrovalRouteHistory_Save_Action extends Vtiger_Save_Action {
...
/* 	public function checkPermission(Vtiger_Request $request) {
	...
	public function process(Vtiger_Request $request) {
		...
		$isDuplicate = $request->get('duplicate');
		...
		if($isDuplicate == 1){
			// $motiwRecordId = $request->get('cf_6310');
			$motiwRecordId = 77777;
			$loadUrl = "gems/index.php?module=MOTIW&view=Detail&record=3107075&app=MARKETING";
		}
