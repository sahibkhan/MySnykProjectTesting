...
Class ItemTRXMaster_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$INCORRECT_REFERENCE_NO_flag  = false;
		$INCORRECT_REFERENCE_NO = $request->get('INCORRECT_REFERENCE_NO');
		if(isset($INCORRECT_REFERENCE_NO) && $INCORRECT_REFERENCE_NO==true){
			$INCORRECT_REFERENCE_NO_flag  = true;
		}
		$viewer->assign('INCORRECT_REFERENCE_NO_flag', $INCORRECT_REFERENCE_NO_flag);
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			$recordModel->set('cf_5591',$assign_warehouse_id);
