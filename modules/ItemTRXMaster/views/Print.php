...
class ItemTRXMaster_Print_View extends Vtiger_Print_View {
	...
	public function print_pick_list($request)
	{
		...
		//echo "<pre>";print_r($models_1);exit;
		$ItemTRXDetail_items = '';
		$i=1;
		foreach($models_1 as $key => $model){
			...
			$ItemTRXDetail_items .='<tr>
									...
									<td>'.$ItemTRXDetail_info->getDisplayValue('item_post_status').'</td>
									</tr>';
		}
		//echo "<table>".$ItemTRXDetail_items."</table>";exit;
		...
		$pdf_name = 'pdf_docs/pm_requisition.pdf';
