 ...
 */
class MOTIW_Field_Model extends Vtiger_Field_Model {
	...
	public function getFieldDataType() {
		if(!$this->fieldDataType) {
			...
			if($uiType == '69') {
				...
				$fieldDataType = 'companyList';
			} else if($uiType == '9999'){
				$fieldDataType = 'companySubList';
			} else if($uiType == '998'){
				$fieldDataType = 'ChartofAccountTypeList';
			} else if($uiType == '997'){
				$fieldDataType = 'ChartofAccountList';
			} else if($uiType == '996'){
				$fieldDataType = 'CompanyAccountList';
			} else if($uiType == '995'){
				$fieldDataType = 'CompanyAccountTypeList';
			} else if($uiType == '899'){
				$fieldDataType = 'departmentList';
			} else if($uiType == '898'){
				$fieldDataType = 'locationList';
			} else if($uiType == '798'){
				$fieldDataType = 'makeList';
			} else if($uiType == '767'){
				$fieldDataType = 'modelList';
			} else if($uiType == '766'){
				$fieldDataType = 'TruckTypeList';	
			} else if($uiType == '768'){
				$fieldDataType = 'TruckList';
			} else if($uiType == '763'){
				$fieldDataType = 'TrailerList';
			} else if($uiType == '699'){
				$fieldDataType = 'InsuranceRateList';
			} else if($uiType == '698'){
				$fieldDataType = 'CommodityTypeList';
			} else if($uiType == '697'){
				$fieldDataType = 'SpecialRangeList';
			} else if($uiType == '696'){
				$fieldDataType = 'MainSpecialRangeList';
			} else if($uiType == '695'){
				$fieldDataType = 'InsuranceTypeList';
			} else if($uiType == '599'){
				$fieldDataType = 'DriverList';
			} else if($uiType == '10000'){
				$fieldDataType = 'RRSSupervisorList';
			} else if($uiType == '499'){
				$fieldDataType = 'JobFileList';
			}else if($uiType == '498'){
				$fieldDataType = 'CustomsCarrierJobFileList';
			}else if($uiType == '598'){
				$fieldDataType = 'FleetUserList';
			}else if($uiType == '597'){
				$fieldDataType = 'GLKUserList';
			}else if($uiType == '596'){
				$fieldDataType = 'AccountantList';
			}else if($uiType == '601'){
                $fieldDataType = 'UsersList';
            }else if($uiType == '495'){
                $fieldDataType = 'CountryHolidays';
            }else if($uiType == '489') {
				$fieldDataType = 'dictionaryList';			
			}else if($uiType == '555') {
				$fieldDataType = 'RoomList';	
			} else if($uiType == '556') {
				$fieldDataType = 'PackingRoomList';	
			} else if($uiType == '557') {
				$fieldDataType = 'PackingBoxList';	
			} else if($uiType == '444') {
				$fieldDataType = 'QhseList';
			} else if($uiType == '666') {
				$fieldDataType = 'SupervisorList';	
			} else if($uiType == '777') {
				$fieldDataType = 'FleetList';
			} else if($uiType == '333') {
				$fieldDataType = 'PMTypeList';
			} else if($uiType == '765') {
				$fieldDataType = 'NominationsList';			
			} else if($uiType == '764') {
				$fieldDataType = 'TripTemplatesList';			
			} else if($uiType == '994') {
				$fieldDataType = 'PackerList';			
			} else if ($uitype == '9940') {
				$fieldDataType = 'MultiplePackerList';
			} else if ($uiType == '11006'){
				$fieldDataType = 'WHParentLocationList';
			}else if ($uiType == '11007'){
				$fieldDataType = 'WHUOMList';
			}else if ($uiType == '11008'){
				$fieldDataType = 'WHItemCatList';
			}else if ($uiType == '11009'){
				$fieldDataType = 'WHDocumentTypeList';
			}else if ($uiType == '11010'){
				$fieldDataType = 'WarehouseList';
			}else if ($uiType == '11011'){
				$fieldDataType = 'WHItemMasterList';
			}else if ($uiType == '11012') {
				$fieldDataType = 'WHLocationList';
			}else if ($uiType == '11013'){
				$fieldDataType = 'ToWarehouseList';
			}else if ($uiType == '11014') {
				$fieldDataType = 'ToWHLocationList';
			}else if ($uiType == '11015') {
				$fieldDataType = 'PackingRequisitionList';
			}else if($uiType =='12001'){
				$fieldDataType = 'WagonList';
			}else if($uiType =='12002'){
				$fieldDataType = 'WagonTripTemplatesList';
			}else if($uiType =='12003'){
				$fieldDataType = 'Multiowner';
			}else if($uiType =='13001'){
				$fieldDataType = 'AppraisalCategoriesList';
			}			
			...
			} else if($uiType == '55' && $this->getName() === 'cf_1520') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1084') {
				$fieldDataType = 'salutationunit';
			} else if($uiType == '55' && $this->getName() === 'cf_1522') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1086') {
				$fieldDataType = 'salutationunitvolume';
			} else if($uiType == '55' && $this->getName() === 'cf_1721') {
				$fieldDataType = 'currencyList';
			} else if($uiType == '55' && $this->getName() === 'cf_1524') {
				$fieldDataType = 'salutationcargovalue';
			} else if($uiType == '55' && $this->getName() === 'cf_1685') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1683') {
				$fieldDataType = 'salutationunit';
			} else if($uiType == '55' && $this->getName() === 'cf_1689') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1687') {
				$fieldDataType = 'salutationunitvolume';
			} else if($uiType == '55' && $this->getName() === 'cf_1723') {
				$fieldDataType = 'currencyList';
			} else if($uiType == '55' && $this->getName() === 'cf_1691') {
				$fieldDataType = 'salutationcargovalue';
			} else if($uiType == '55' && $this->getName() === 'cf_1641') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1639') {
				$fieldDataType = 'salutationunit';
			} else if($uiType == '55' && $this->getName() === 'cf_1645') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1643') {
				$fieldDataType = 'salutationunitvolume';
			} else if($uiType == '55' && $this->getName() === 'cf_1725') {
				$fieldDataType = 'currencyList';
			} else if($uiType == '55' && $this->getName() === 'cf_1647') {
				$fieldDataType = 'salutationcargovalue';
			} 
			
			//Pretrip
			else if($uiType == '55' && $this->getName() === 'cf_4307') {
				$fieldDataType = 'picklist';
			}
			else if($uiType == '55' && $this->getName() === 'cf_4305') {
				$fieldDataType = 'salutationunit';
			}
			//Posttrip
			 else if($uiType == '55' && $this->getName() === 'cf_4329') {
				$fieldDataType = 'picklist';
			}
			else if($uiType == '55' && $this->getName() === 'cf_4319') {
				$fieldDataType = 'salutationunit';
			}
			
			//TripExpense
			 else if($uiType == '55' && $this->getName() === 'cf_4975') {
				$fieldDataType = 'picklist';
			}
			else if($uiType == '55' && $this->getName() === 'cf_4961') {
				$fieldDataType = 'salutationunit';
			}
			
			//BO
			else if($uiType == '55' && $this->getName() === 'cf_1473') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1287') {
				$fieldDataType = 'salutationunit';
			} else if($uiType == '55' && $this->getName() === 'cf_1475') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1289') {
				$fieldDataType = 'salutationunitvolume';
			} else if($uiType == '55' && $this->getName() === 'cf_1727') {
				$fieldDataType = 'currencyList';
			} else if($uiType == '55' && $this->getName() === 'cf_1469') {
				$fieldDataType = 'salutationcargovalue';
			} 
			//VPO
			else if($uiType == '55' && $this->getName() === 'cf_1597') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1409') {
				$fieldDataType = 'salutationunit';
			} else if($uiType == '55' && $this->getName() === 'cf_1599') {
				$fieldDataType = 'picklist';
			} else if($uiType == '55' && $this->getName() === 'cf_1411') {
				$fieldDataType = 'salutationunitvolume';
			} else if($uiType == '55' && $this->getName() === 'cf_1729') {
				$fieldDataType = 'currencyList';
			} else if($uiType == '55' && $this->getName() === 'cf_1415') {
				$fieldDataType = 'salutationcargovalue';
			}  
			
			//FLeet
			else if($uiType == '55' && $this->getName() === 'cf_2039') {
				$fieldDataType = 'picklist';
			} 
			else if($uiType == '55' && $this->getName() === 'cf_1989') {
				$fieldDataType = 'salutationunit';
			}
			else if($uiType == '55' && $this->getName() === 'cf_2041') {
				$fieldDataType = 'picklist';
			}
			else if($uiType == '55' && $this->getName() === 'cf_1991') {
				$fieldDataType = 'salutationunitvolume';
			}
			
			//FLeettrip
			else if($uiType == '55' && $this->getName() === 'cf_3233') {
				$fieldDataType = 'picklist';
			} 
			else if($uiType == '55' && $this->getName() === 'cf_3229') {
				$fieldDataType = 'salutationunit';
			}
			else if($uiType == '55' && $this->getName() === 'cf_3235') {
				$fieldDataType = 'picklist';
			}
			else if($uiType == '55' && $this->getName() === 'cf_3231') {
				$fieldDataType = 'salutationunitvolume';
			}
