...
class MOTIW_Save_Action extends Vtiger_Save_Action {
	...
	public function createApprovalRoute(Vtiger_Request $request){
  	...
  	$contractRecordModel = Vtiger_Record_Model::getInstanceById($request->get('record'), 'MOTIW');
		// echo "<pre>"; print_r($request->get('record')); exit;
		// $contractRecordModel = $contractRecordModel->get('first_name');
		// echo "<pre>"; print_r($contractRecordModel->get('assigned_user_id')); exit;
		...
		// echo "<pre>"; print_r($CONTRACT_OWNER_ID); exit;
