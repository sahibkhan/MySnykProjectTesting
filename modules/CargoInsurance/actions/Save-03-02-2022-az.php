			...
			*/  
			...
			if(!empty($rate_id)  && !empty($special_range_id))
			{
				...
				if($count_commodityrates_by_type!=0)
				{
					...
					$wis_rate = $commodity_rate_list->get('wis_net_rate'); //conv rate
					$centras_rate =  $commodity_rate_list->get('wis_jusan_markup'); // jusan markup
					$agent_rate =  $commodity_rate_list->get('wis_agent_commission_rate'); //agent comm rate
					$globalink_rate =  $commodity_rate_list->get('wis_gross_rate'); // gross rate
					$rate_limit = $commodity_rate_list->get('wis_rate_limit'); // rate limit
				}
				...
				if(floatval($total_insured_sum_in_dollar)> floatval($rate_limit))
				{
					$agent_rate = '0.00';
					$centras_rate = '0.00';
					$agent_premium = '0.00';
