		...
		if($eventName == 'vtiger.entity.aftersave') {
			...
			if ($relatedToId && $data->getModuleName() == 'ModComments') {
				...
				if(!$isPrivateComment) {
					...
					$_SESSION['commented_modname'] = $entityData->getModuleName(); 
					$_SESSION['commented_mod_record'] = $entityData->getId();
					$fact_mod = $_REQUEST['module'];
					if (($fact_mod == '') || ($fact_mod == 'ModComments')){
						comments_handler($_SESSION['commented_modname'],$_SESSION['commented_mod_record']);
						// comments_handler('Quotes', 3141682);
					}
