...
class CustomPackingMaterial_QuickCreateAjax_View extends Vtiger_QuickCreateAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$request->set('cf_6278', date('d-m-Y'));			
		...
		$recordModel->set('cf_6272',$assign_warehouse_id);
		
		$parentId = $request->get('sourceRecord');
		$sourceModule = $request->get('sourceModule');
		$parentRecordModel = Vtiger_Record_Model::getInstanceById($parentId, $sourceModule);
		$recordModel->set('cf_6284',$parentRecordModel->get('cf_6238'));
		$recordModel->set('name',$parentRecordModel->get('cf_5754'));
