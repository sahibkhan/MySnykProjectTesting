...
Class ExitInterview_Edit_View extends Vtiger_Edit_View {
  ...
  if(!empty($record) && $request->get('isDuplicate') == true) {
    ...
    {	
      if($request->get('returnmodule') == 'Resignation' && $request->get('returnrecord')) 
      {
        ...
        $request->set('cf_7468', $userList->getDisplayValue('cf_3431')); // Employment Date
        $request->set('cf_7492', $resignationRequest->getDisplayValue('cf_7450')); // Date

        $request->set('cf_7466', $userList->get('cf_823')); // Position
      }
