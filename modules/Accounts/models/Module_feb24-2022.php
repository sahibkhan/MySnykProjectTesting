	...
	public static function getSearchResultForJObAndOthers($searchKey, $module=false) {
		...
		if($module=="Accounts")
		{
			...
			*/
			...
			if (($field == 'cf_1441_display' || $field == 'cf_1443_display' || $field=='cf_1443_display[]' || $field=='cf_1445_display' || $field=='related_to_display' || $field=='account_id_display') ) {
			...
			elseif(($field == 'cf_1082_display' || $field=='cf_1176_display' || $field=='cf_1176_display[]' || $field=='cf_1367_display' || $field=='cf_1377_display' || $field=='campaignid_display' || $field=='cf_1827_display')) {
				//For claims customer
