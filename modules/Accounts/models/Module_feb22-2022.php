	...
	public function getQueryByModuleField($sourceModule, $field, $record, $listQuery) {
		...
		if (($sourceModule == 'Accounts' && $field == 'account_id' && $record)
			...
			if (($field == 'proc_supplier') ) {
				$condition = " vtiger_crmentity.setype='Accounts' AND (vtiger_account.account_type='Vendor' || vtiger_account.account_type='Agent' || vtiger_accountscf.cf_7814='Yes') AND vtiger_accountscf.cf_2403 IN('Approved', 'Confirmed') AND  vtiger_serviceagreementcf.cf_6068 = 'Administrative'
	...
	public static function getSearchResultForProcurement($searchKey, $module=false) {
		...
		if($module=="Accounts")
		{
			...
			*/
			...
			//mehtab code
			$new_condition = " AND (vtiger_account.account_type='Vendor' || vtiger_account.account_type='Agent' || vtiger_accountscf.cf_7814='Yes') AND vtiger_accountscf.cf_2403 IN('Approved', 'Confirmed') AND  vtiger_serviceagreementcf.cf_6068 = 'Administrative'
				AND '".date('Y-m-d')."' between vtiger_serviceagreementcf.cf_6018 AND vtiger_serviceagreementcf.cf_6020 ";
