	...
	public function getQueryByModuleField($sourceModule, $field, $record, $listQuery) {
		...
		if (($sourceModule == 'Accounts' && $field == 'account_id' && $record)
			...
			if (($field == 'cf_1441' || $field == 'cf_1443' || $field=='cf_1443[]' || $field=='cf_1445' || $field=='related_to' || $field=='account_id') ) {
				$condition = " vtiger_crmentity.setype='Accounts' AND (vtiger_account.account_type='Customer' || vtiger_account.account_type='Agent') ";
			}
			elseif(($field == 'cf_1082' || $field=='cf_1176' || $field=='cf_1176[]' || $field=='cf_1367' || $field=='cf_1377' || $field=='campaignid' || $field=='cf_1827')) {
				...
				if($field=='cf_1367') {
					...
					$condition = " vtiger_crmentity.setype='Accounts' AND (vtiger_account.account_type='Vendor' || vtiger_account.account_type='Agent') ";
			...
			if (($field == 'proc_supplier') ) {
				$condition = " vtiger_crmentity.setype='Accounts' AND (vtiger_account.account_type='Vendor' || vtiger_account.account_type='Agent') AND  vtiger_serviceagreementcf.cf_6068 = 'Administrative'
