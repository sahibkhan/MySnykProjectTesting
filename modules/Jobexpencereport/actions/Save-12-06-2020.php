...
class Jobexpencereport_Save_Action extends Vtiger_Save_Action {
	...
	public function profit_share($request)
	{
		...
		$loadURL = 'index.php?module=Job&relatedModule='.$request->get('module').'&view=Detail&record='.$request->get('record').'&mode=showRelatedList&relationId=167&tab_label=Job%20Revenue%20and%20Expence&app=MARKETING';
		header("Location: $loadUrl");	
