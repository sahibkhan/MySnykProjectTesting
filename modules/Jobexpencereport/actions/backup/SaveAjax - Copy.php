...
class Jobexpencereport_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function selling($request)
	{
		...
		{		
			...
			$params_up = array($job_id, $extra_selling_normal['b_gl_account'], $extra_selling_normal['b_ar_gl_account'], $extra_selling_normal['company_id'], $extra_selling_normal['user_id'], $extra_selling_normal['owner_id'], $extra_selling_normal['s_jrer_buying_id'], $jobexpencereportid);
