	...
	public function fleet_buying_edit($request)
	{
		...
		if($recordId!=0)
		{
			...
			$query_count_job_jrer_buying = "SELECT * FROM vtiger_jobexpencereportcf
														 ...
														 AND vtiger_jobexpencereportcf.cf_2195=? AND vtiger_jobexpencereportcf.cf_2193='' limit 1	
														 ";
			$job_id = $job_id;		 
			$params_fleet_jrer = array(@$job_info->get('record_id'), $expense_truck_id);
			...
			$query_count_job_jrer_buying = "SELECT * FROM vtiger_jobexpencereportcf
														 ...
														 WHERE vtiger_crmentity.deleted=0 AND crmentityrel.crmid=? 
														 AND crmentityrel.module='Job' AND crmentityrel.relmodule='Jobexpencereport'
														 AND vtiger_jobexpencereportcf.cf_2195=? AND vtiger_jobexpencereportcf.cf_2193='Yes' limit 1	
														 ";
			$job_id = $job_id;		 
			$params_fleet_jrer = array(@$job_info->get('record_id'), $expense_truck_id);
			...
			if($job_info->get('assigned_user_id')!=$current_user->getId())
				...
				*/
				...
				$query_sub_fleet_update_sub = "UPDATE vtiger_jobexpencereportcf
													   ...
													   WHERE vtiger_jobexpencereportcf.cf_1453='44515' AND vtiger_crmentityrel.crmid='".$job_id."' ";
