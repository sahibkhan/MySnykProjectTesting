...
class Jobexpencereport_Print_View extends Vtiger_Print_View {
	...
	public function print_wagon_pv($request)
	{
		...
		foreach($models_1 as $key => $model){
				...
				$params_buy_local = array($model->get('cf_3175'), $wagon_location_id, '1414775', $wagontripid, $roundtrip_info->get('assigned_user_id'));
				...
				$cost = 0;
						...
						$params_internal = array($model->get('cf_3175'), $wagon_location_id, '1414775');
