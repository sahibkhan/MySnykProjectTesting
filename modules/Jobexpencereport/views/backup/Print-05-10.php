...
class Jobexpencereport_Print_View extends Vtiger_Print_View {
 ...
 LEFT JOIN vtiger_jobexpencereportcf as vtiger_jobexpencereportcf on vtiger_jobexpencereportcf.jobexpencereportid=vtiger_jobexpencereport.jobexpencereportid 
			...
			<tbody>
				<tr>
					...
					<td width="60" align="center">
						<h5><u>Buy (loc cur gross)</u></h5>
					</td>
					<td width="60" align="center">
						<h5><u>Buy (loc cur net)</u></h5>
					</td>
					<td width="66" align="center">
						<h5><u>Expected buy (cur net)</u></h5>
					</td>
					<td width="44" align="center">
						<h5><u>Var exp and act buying</u></h5>
					</td>
					<td width="60" align="center">
						<h5><u>Total, $</u></h5>
					</td>
		...
		foreach($models as $key => $model)
		{
			...
			$Cur = $model->getDisplayValue('cf_1345');
			$invoice_date = $model->get('cf_1216');
			//$b_exchange_rate = 1;
			if(!empty($invoice_date))
			{
				if($Cur!='USD')
				{
					$b_exchange_rate = currency_rate_convert_kz($Cur, 'USD',  1, $invoice_date);
				}else{
					$b_exchange_rate = currency_rate_convert($Cur, 'USD',  1, $invoice_date);
				}
			}
			$value_in_usd_normal = $model->getDisplayValue('cf_1343');	
			if($Cur!='USD')
			{
				$value_in_usd_normal = $model->getDisplayValue('cf_1343')/$b_exchange_rate;
			}
			
			$value_in_usd = number_format($value_in_usd_normal,2,'.','');
			
			$AccType = $model->getDisplayValue('cf_1214');
            ...
            <td valign="top" width="66">
                '.$paytoinfo->get('accountname').'
            </td>
            <td valign="top" width="66">
                '.$model->getDisplayValue('cf_1453').'
            </td>
            <td valign="top" width="57">
                '.$model->getDisplayValue('cf_1212').'
            </td>
            <td valign="top" width="47" align="center">
                '.$model->getDisplayValue('cf_1216').'
            </td>
            <td valign="top" width="47" align="center">
              '.$model->getDisplayValue('cf_1477').' '.$model->getDisplayValue('cf_1479').'
            </td>
            <td valign="top" width="57" align="center">
                '.$model->getDisplayValue('cf_1214').'
            </td>
            <td valign="top" width="57" align="right">
                 '.$model->getDisplayValue('cf_1337').'
            </td>
            <td valign="top" width="41" align="center">
                 '.$model->getDisplayValue('cf_1339').'
            </td>
            <td valign="top" width="42" align="right">
                '.$model->getDisplayValue('cf_1341').'
            </td>
            <td valign="top" width="72" align="right">
                '.$model->getDisplayValue('cf_1343').'
            </td>
            <td valign="top" width="36" align="center">
                '.$model->getDisplayValue('cf_1345').'
            </td>
            <td valign="top" width="48" align="right">
                '.number_format($model->getDisplayValue('cf_1222'), 2).'
            </td>
            <td valign="top" width="60" align="right">
                '.$model->getDisplayValue('cf_1347').'
            </td>
            <td valign="top" width="60" align="right">
                '.$model->getDisplayValue('cf_1349').'
            </td>
            <td valign="top" width="66" align="right">
                '.$model->getDisplayValue('cf_1351').'
            </td>
            <td valign="top" width="44" align="right">
                '.$model->getDisplayValue('cf_1353').'
            </td>
            <td valign="top" width="60" align="right">
                '.$value_in_usd.'
            </td>
        ...
        <tr>
            ...
            <td valign="top" width="66" align="right">
                <h5><u>Total Local Currency</u></h5>
            </td>
            <td valign="top" width="57">
            </td>
            <td valign="top" width="47">
            ...
            <td valign="top" width="60" align="right">
                <h5><u>'.$BUY_LOCAL_CURRENCY_GROSS.'</u></h5>
            </td>
            <td valign="top" width="60" align="right">
                <h5><u>'.$BUY_LOCAL_CURRENCY_NET.'</u></h5>
            </td>
            <td valign="top" width="66" align="right">
                <h5><u>'.$EXPECTED_BUY_LOCAL_CURRENCY_NET.'</u></h5>
            </td>
            <td valign="top" width="44" align="right">
                <h5><u>'.$VARIATION_EXPECTED_AND_ACTUAL_BUYING.'</u></h5>
            </td>
            <td valign="top" width="60">
            </td>
        </tr>
        <tr>
            ...
            <td valign="top" width="60" align="right">
                <h5><u>'.number_format($final_exchange_rate, 2).'</u></h5>
            </td>
            <td valign="top" width="60" align="right">
                <h5><u>'.number_format($final_exchange_rate, 2).'</u></h5>
            </td>
        ...
        <tr>
            ...
            <td valign="top" width="60" align="right">
                <h5><u>'.$TOTAL_COST_USD_GROSS.'</u></h5>
            </td>
            <td valign="top" width="60" align="right">
                <h5><u>'.$TOTAL_COST_IN_USD_NET.'</u></h5>
            </td>
            <td valign="top" width="66" align="right">
                <h5><u>'.$TOTAL_EXPECTED_COST_USD_NET.'</u></h5>
            </td>
            <td valign="top" width="44" align="right">
                <h5><u>'.$TOTAL_VARIATION_EXPECTED_AND_ACTUAL_BUYING_COST_IN_USD.'</u></h5>
            </td>
            <td valign="top" width="60">
            </td>
        </tr></tbody></table>';
		...
		foreach($models as $key => $model){
			if($model->getDisplayValue('cf_1457') == 'Expence')
			{
				...
				$col_data_P['cf_1477'] = $model->getDisplayValue('cf_1477');
				$col_data_P['cf_1479'] = $model->getDisplayValue('cf_1479');
				
				$col_data_P['cf_1477_location_id'] = $model->get('cf_1477');
				$col_data_P['cf_1479_department_id'] = $model->get('cf_1479');	
	 ...
	 if(!empty($profit_share))
		 ...
		 foreach($profit_share_data as $profit)
		 {
			 ...
			 $profitshare .= '<tr>
							...
							<td valign="top" width="171" align="right">
							'.$profit['cost'].'
							</td>
