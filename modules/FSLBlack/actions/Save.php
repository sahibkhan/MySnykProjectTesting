...
class FSLBlack_Save_Action extends Vtiger_Save_Action {
	...
	public function process(Vtiger_Request $request) {
		try {
			$fsl_department = $request->get('cf_6448');
			//$fsl_department = implode(' |##| ',$fsl_department);
			$fsl_department = implode(',',$fsl_department);
			$request->set('cf_6448',$fsl_department);
