...
class JobTask_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		try {
			...
			$sql = $adb->pquery("update vtiger_jobtask SET job_id = '".$request->get('returnrecord')."', user_id ='".$request->get('assigned_user_id')."' 
								 WHERE jobtaskid = '". $recordModel->getId()."'");
