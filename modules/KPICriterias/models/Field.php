...
/**
 * KPICriterias Field Model Class
 */
class KPICriterias_Field_Model extends Vtiger_Field_Model {
...
//echo $this->getName();
		...
		if($this->get('uitype') == '7' and $this->getName() === 'criteria_min'){
			return minunit;
		} else if($this->get('uitype') == '7' and $this->getName() === 'criteria_max'){
			return maxunit;
		} else if($this->get('uitype') == '7' and $this->getName() === 'criteria_weightage'){
