...
Class KPICriterias_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$MinunitFieldModel = Vtiger_Field_Model::getInstance('kpic_min_type', $recordModel->getModule());
		$MinunitFieldModel->set('fieldvalue', $recordModel->get('kpic_min_type'));
		$viewer->assign('MINUNIT_FIELD_MODEL', $MinunitFieldModel);

		$MaxunitFieldModel = Vtiger_Field_Model::getInstance('kpic_max_type', $recordModel->getModule());
		$MaxunitFieldModel->set('fieldvalue', $recordModel->get('kpic_max_type'));
		$viewer->assign('MAXUNIT_FIELD_MODEL', $MaxunitFieldModel);

		$WeightageunitFieldModel = Vtiger_Field_Model::getInstance('kpic_weightage_type', $recordModel->getModule());
		$WeightageunitFieldModel->set('fieldvalue', $recordModel->get('kpic_weightage_type'));
		$viewer->assign('WEIGHTAGEUNIT_FIELD_MODEL', $WeightageunitFieldModel);
