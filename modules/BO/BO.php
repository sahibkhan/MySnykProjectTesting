...
class BO extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_bo';
	var $table_index= 'boid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_bocf', 'boid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_bo', 'vtiger_bocf');
