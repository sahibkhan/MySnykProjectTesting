...
class BO_Print_View extends Vtiger_Print_View {
	...
	//	$sign_details = str_replace($breaks, "\r\n", $sign_details);
		...
		$agreementno = $this->get_agreement_no($module_data_info->get('cf_1295'),$module_data_info->get('account_id'),$request_date);
		...
		$this->setValue('transportation_cost', $module_data_info->getDisplayValue('cf_1311'), ENT_QUOTES, "UTF-8");
...
// error_reporting(E_ALL);
		...
		$document->setValue('destination', $destination);
		...
		$document->setValue('transportation_cost', $transportation_cost);
