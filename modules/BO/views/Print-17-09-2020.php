...
class BO_Print_View extends Vtiger_Print_View {
	...
	//	$sign_details = str_replace($breaks, "\r\n", $sign_details);
		...
		{
			$document = $this->loadTemplate('printtemplates/BO/BO_eng_1.html');
		}
		elseif($request->get('template') == 'rus_1')
		{
			$document = $this->loadTemplate('printtemplates/BO/BO_rus_1.html');
		}
		...
		$this->setValue('shipper_name', $module_data_info->getDisplayValue('cf_1275'), ENT_QUOTES, "UTF-8");
		$this->setValue('consignee_name', $module_data_info->getDisplayValue('cf_1465'), ENT_QUOTES, "UTF-8");
...
// error_reporting(E_ALL);
		...
		".$module_data_info->getDisplayValue('cf_1287')."
		 ...
		 // Shipper info
		 $shipper_info  = html_entity_decode($module_data_info->getDisplayValue('cf_1275'));
		...
		if($request->get('template') == 'eng_1')
		{
		$document = $PHPWord->loadTemplate('include/BO/BO_new_English_01.docx');
		}
		elseif($request->get('template') == 'rus_1')
		{
		$document = $PHPWord->loadTemplate('include/BO/BO_Rus_new_01.docx');
		}
		elseif($request->get('template') == 'eng_2')
		{
