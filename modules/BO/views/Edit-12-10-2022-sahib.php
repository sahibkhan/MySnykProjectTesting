...
/* 			$sourceRecord =  $request->get('sourceRecord');
			...
			$GEN_COUNTRY_CODE = $job_info->get('cf_1504');
			$GEN_STATE_CODE = $job_info->get('job_origin_states');
			$viewer->assign('GEN_COUNTRY_CODE',$GEN_COUNTRY_CODE);
			$viewer->assign('GEN_STATE_CODE',$GEN_STATE_CODE);

			//General Destination Country and Destination states code

			$GEN_DEST_COUNTRY_CODE = $job_info->get('cf_1506');
			$GEN_DEST_STATE_CODE = $job_info->get('job_destination_states');
			$viewer->assign('GEN_DEST_COUNTRY_CODE',$GEN_DEST_COUNTRY_CODE);
			$viewer->assign('GEN_DEST_STATE_CODE',$GEN_DEST_STATE_CODE);
			...
			$request->set('bo_origin_state', $job_info->get('job_origin_states')); //origin_state
			$request->set('cf_1283', $job_info->get('cf_1506')); //destination_country
			$request->set('bo_destination_state', $job_info->get('job_destination_states')); //destination_state
