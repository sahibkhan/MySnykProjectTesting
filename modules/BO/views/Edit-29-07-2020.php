...
Class BO_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			$request->set('cf_1301', $job_info->get('cf_1516')); //expected_date_of_loading
			$request->set('cf_1587', $job_info->get('cf_1583')); //expected_date_of_delivery
			$request->set('cf_1593', $job_info->get('cf_1589')); //etd
			$request->set('cf_1595', $job_info->get('cf_1591')); //eta
			...
			$request->set('cf_1473', $job_info->get('cf_1520')); //weight unit
			$request->set('cf_1289', $job_info->get('cf_1086')); //Volumne
			$request->set('cf_1475', $job_info->get('cf_1522')); //Volume unit
			$request->set('cf_1469', $job_info->get('cf_1524')); //Cargo Value	
			$request->set('cf_1727', $job_info->get('cf_1721')); //Cargo unit
