		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			{				
				if($request->get('returnmodule') == 'Job' && $request->get('returnrecord')) 
				{
					...
					$request->set('cf_2165', $job_info->get('cf_1516')); //expected_date_of_loading
					$request->set('cf_2167', $job_info->get('cf_1583')); //expected_date_of_delivery
					$request->set('cf_2169', $job_info->get('cf_1589')); //etd
					$request->set('cf_2171', $job_info->get('cf_1591')); //eta
