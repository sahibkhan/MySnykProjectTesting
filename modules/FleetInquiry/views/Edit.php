...
Class FleetInquiry_Edit_View extends Vtiger_Edit_View {
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			{				
				if($request->get('returnmodule') == 'Job' && $request->get('returnrecord')) 
				{
					...
					$request->set('cf_3297', $job_info->get('cf_1198')); //Job ref no
					$request->set('cf_2145', $job_info->get('cf_1072')); //shipper
					$request->set('cf_2147', $job_info->get('cf_1074')); //consignee
					$request->set('cf_2165', $job_info->getDisplayValue('cf_1516')); //expected_date_of_loading
					$request->set('cf_2167', $job_info->getDisplayValue('cf_1583')); //expected_date_of_delivery
					$request->set('cf_2169', $job_info->getDisplayValue('cf_1589')); //etd
					$request->set('cf_2171', $job_info->getDisplayValue('cf_1591')); //eta
					$request->set('cf_2137', $job_info->get('cf_1429')); //number_of_items
					$request->set('cf_2143', $job_info->get('cf_1585')); //special_instructions
					$request->set('cf_2141', $job_info->get('cf_1084')); //weight
					$request->set('cf_2135', $job_info->get('cf_1518')); //commodity
					$request->set('cf_2219', $job_info->get('cf_1188')); //office
					//$request->set('cf_2219', $job_info->get('cf_1188')); //department

					$request->set('cf_2211', $job_info->get('cf_1504')); //origin_country
					$request->set('cf_2213', $job_info->get('cf_1506')); //destination_country
					$request->set('cf_2215', $job_info->get('cf_1508')); //origin_city
					$request->set('cf_2217', $job_info->get('cf_1510')); //destination_city
					$request->set('cf_2207', $job_info->get('cf_1512')); //pickup_address
					$request->set('cf_2209', $job_info->get('cf_1514')); //delivery_address					
				}
			}
		}
		if(!$this->record){
