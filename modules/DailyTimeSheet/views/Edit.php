...
Class DailyTimeSheet_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		//05.10.2020:: Mehtab updated: To add relatedlist module under parent module
		//ALTER TABLE `vtiger_cf_6904` ADD `color` VARCHAR(10) NULL AFTER `presence`;
		$moduleName = $request->getModule();
		$relatedModuleName = "DailyTimeSheetTask";//$request->get('relatedModule');
