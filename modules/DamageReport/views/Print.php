...
class DamageReport_Print_View extends Vtiger_Print_View {
	...
	function process(Vtiger_Request $request) {
		...
		*/
		...
		//$this->setValue('dep',htmlentities($owner_user_info->getDisplayValue('department_id'), ENT_QUOTES, "UTF-8"));	
		//It must be job department
		$this->setValue('dep',htmlentities($job_info->getDisplayValue('cf_1190'), ENT_QUOTES, "UTF-8"));	
		
		$this->setValue('station', htmlentities($owner_user_info->getDisplayValue('location_id'), ENT_QUOTES, "UTF-8"));	
