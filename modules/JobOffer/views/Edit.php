...
Class JobOffer_Edit_View extends Vtiger_Edit_View {
...
public function process(Vtiger_Request $request) {
  ...
  if(!empty($record) && $request->get('isDuplicate') == true) {
    ...
    if(empty($record))
    {	
      if($request->get('returnmodule') == 'InterviewAssessment' && $request->get('returnrecord')) 
      {
        ...
        $request->set('cf_7236', $job_info->get('cf_7182')); // Location
        $request->set('cf_7238', $job_info->get('cf_7180')); // Department
        $request->set('cf_7232', $job_info->get('cf_7176')); // Position
        $request->set('cf_7230', $job_info->get('cf_7174')); // Age
