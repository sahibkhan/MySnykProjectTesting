...
class Leaverequest_ExportData_Action extends Vtiger_ExportData_Action {
	...
	function ExportData(Vtiger_Request $request) {
		...
		$newhtml = '<table>
									<thead>
										<tr>
										<th colspan="2" style="font-weight:bold;text-align:center;text-align:center">Leave Request</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Requested By</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Office</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Type of leave</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Department</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Modified Time</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Created Time</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Branch</th>
										<th colspan="2" style="font-weight:bold;text-align:center">From Date</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Till Date</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Leave Days</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Remind Me on</th>
										<th colspan="2" style="font-weight:bold;text-align:center">From and Till time</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Created By</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Head Approval</th>
										<th colspan="2" style="font-weight:bold;text-align:center">Head Approved On</th>
										<th colspan="2" style="font-weight:bold;text-align:center">HR Approval</th>
										<th colspan="2" style="font-weight:bold;text-align:center">HR Approved On</th>
										<th colspan="2" style="font-weight:bold;text-align:center">FD Approval</th>
										<th colspan="2" style="font-weight:bold;text-align:center">FD Approved On</th>
										</tr>
									</thead>
									<tbody>
		';
		...
		foreach($entries as $data){
			$newhtml .='<tr>
									...
									<td colspan="2">'.$data['cf_3423'].'</td>
									<td colspan="2">'.$data['cf_3469'].'</td>
									<td colspan="2">'.$data['cf_3409'].'</td>
									<td colspan="2">'.$data['cf_3467'].'</td>
									<td colspan="2">'.$data['modifiedtime'].'</td>
									<td colspan="2">'.$data['createdtime'].'</td>
									<td colspan="2">'.$data['cf_4801'].'</td>
									<td colspan="2">'.$data['cf_3391'].'</td>
									<td colspan="2">'.$data['cf_3393'].'</td>
									<td colspan="2">'.$data['cf_7756'].'</td>
									<td colspan="2">'.$data['cf_7762'].'</td>
									<td colspan="2">'.$data['cf_5355'].'</td>
									<td colspan="2">'.$data['smownerid'].'</td>
									<td colspan="2">'.$data['cf_3411'].'</td>
									<td colspan="2">'.$data['cf_3413'].'</td>
									<td colspan="2">'.$data['cf_3415'].'</td>
									<td colspan="2">'.$data['cf_3417'].'</td>
									<td colspan="2">'.$data['cf_6618'].'</td>
									<td colspan="2">'.$data['cf_6620'].'</td>
		...
		foreach($arr as $fieldName=>&$value){
			...
			if($fieldname != 'hdnTaxType' && ($uitype == 15 || $uitype == 16 || $uitype == 33)){
				...
				if ($value && $value != '0000-00-00') {
					...
					$value = DateTimeField::__convertToUserFormat($value, 'yyyy-mm-dd');
				}
