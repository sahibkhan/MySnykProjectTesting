...
function leave_msg_handler($module,$record,$current_user, $recordModel){
    ...
    //$current_user_email = get_user_details($current_user,1);$c
    ...
    */
    ...
    foreach ($to as $person1) $s_cc .= $person1.",";

/* 
    $from = 'r.gusseinov@globalinklogistics.com';
    $s_to = 'r.gusseinov@globalinklogistics.com';
    $body = '';
    $body .= "<html>
    <head>
    <style> 
    ...
    $body .= "<tr><td colspan=2> Info: $s_cc </td></tr>";	

    $body .= "<tr><td colspan=2 >Please see details on this link: <a href='#'> Link </a></td></tr>";	
