...
class ContractAgreementTemplate_Record_Model extends Vtiger_Record_Model {
	...
	public function getAttachmentId() {
		...
		$queryAttachments = "SELECT attachmentsid FROM `vtiger_seattachmentsrel` WHERE `crmid` = ? LIMIT 1";
		$resultAttachments = $adb->pquery($queryAttachments, array($this->get('id')));
