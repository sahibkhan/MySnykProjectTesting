			...
			if($current_user->get('roleid')=='H184')
			{
				...
				foreach($models as $key => $model){
					...
					if($expense_record->getDisplayValue('cf_1214')!='')
					{
						...
						$action .='&nbsp;<a href="index.php?module=Jobexpencereport&view=Print&record='.$model->getId().'&fleettripid='.$fleettrip_id.'&expense=PV" target="_blank">
										 <i title="Print Fleet Payment Voucher" class="fa fa-print alignMiddle"></i></a>&nbsp;';
					}
