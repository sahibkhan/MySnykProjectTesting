...
Class Fleettrip_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			$recordModel = $this->record?$this->record:Vtiger_Record_Model::getInstanceById($record, $moduleName);
			$viewer->assign('MODE', '');
			$recordModel->set('cf_4803', 'In Progress');
			$recordModel->set('cf_3283', ''); //Fleet trip no
			$recordModel->set('cf_3165', ''); // truck no
			$recordModel->set('cf_5139', ''); // trailer no
			$recordModel->set('cf_4517', ''); //trip template
			$recordModel->set('cf_3167', ''); //driver			
		...
		$salutationFieldModel = Vtiger_Field_Model::getInstance('cf_3233', $recordModel->getModule());
		$salutationFieldModel->set('fieldvalue', $recordModel->get('cf_3233'));
		$viewer->assign('SALUTATION_FIELD_MODEL', $salutationFieldModel);
		
		$salutationFieldModelVolume = Vtiger_Field_Model::getInstance('cf_3235', $recordModel->getModule());
		$salutationFieldModelVolume->set('fieldvalue', $recordModel->get('cf_3235'));
