 ...
 */
class Attendencereport_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getSideBarLinks($linkParams) {
		...
		//echo "<pre>"; print_r($moduleLinks); exit;
		return $moduleLinks;
	}
	 ...
	 */
	public function getListViewEntries1($pagingModel) {
		echo "sss";
		$db = PearDatabase::getInstance();

		$moduleName = "Attendencesystem";
		...
		$search_params='%5B%5B%5B"cf_799"%2C"e"%2C"0"%5D%5D%5D';
		...
		echo "<pre>"; print_r($listViewEntries); exit;
