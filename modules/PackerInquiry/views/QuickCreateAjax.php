...
class PackerInquiry_QuickCreateAjax_View extends Vtiger_QuickCreateAjax_View {
		...
		if($request->get('returnmodule') == 'Job' && $request->get('returnrecord')) 
			{
				...
				$request->set('cf_5331', $job_info->get('cf_1198')); //Job ref no
				$request->set('cf_5337', $job_info->get('cf_1188')); //Job office
				$request->set('cf_5335', $job_info->get('cf_1190')); //Job department
				$request->set('cf_5415', $job_info->get('cf_1441')); //Job beneficiary
			}
