...
class Overtime_QuickCreateAjax_View extends Vtiger_QuickCreateAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$job_info = Vtiger_Record_Model::getInstanceById($parentId, $sourceModule);
		$recordModel->set('cf_5413', $job_info->get('cf_1198'));
