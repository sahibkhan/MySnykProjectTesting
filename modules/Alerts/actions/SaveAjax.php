...
class Alerts_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		try {
			...
			// Recalculate Social event budget
			if (isset($_REQUEST['sourceRecord'])){
				$sourceRecordId = $_REQUEST['sourceRecord'];				
				require_once('modules/SocialEvent/SocialEvent.php');
				$instanceOfSocailEvent = new SocialEvent();
				$totalParticipants = $instanceOfSocailEvent->calculateEventAmount($sourceRecordId);
			}
