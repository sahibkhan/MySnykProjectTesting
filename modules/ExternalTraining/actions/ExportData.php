...
class ExternalTraining_ExportData_Action extends Vtiger_ExportData_Action {
    ...
    $newhtml .='<table>
                ...
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Training Name</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Reference No</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Requested By</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Created By</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Location</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Department</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Training Start Date</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Training End Date</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Training Type</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Training Provider</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Training Agreement</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Duration of Training.</th>
                <th colspan="2" style="background-color:#CCCCFF;border:1px solid black" align="center">Aim of Training</th>
                </tr>
                </thead>
                <tbody>';
    foreach($entries as $key => $entry)
		{
      echo $entry['name'];exit;
      $user_info = Users_Record_Model::getInstanceById($entry['name'], 'Users');
      echo "<pre>";
      print_r($user_info);exit;
      $user_name = $user_info->get('first_name').' '.$user_info->get('last_name');
    $newhtml .='<tr>
                <td colspan="2" align="left">'.$entry['cf_7624'].'</td>
                <td colspan="2" align="left">'.$entry['cf_7354'].'</td>
                <td colspan="2" align="left">'.$user_name.'</td>
                <td colspan="2" align="left">'.$user_name.'</td>
                <td colspan="2" align="left">'.$user_name.'</td>
                <td colspan="2" align="left">'.$user_name.'</td>
                <td colspan="2" align="left">'.$entry['cf_7364'].'</td>
                </tr>';
    }
    $newhtml .='</tbody>
    </table>';
