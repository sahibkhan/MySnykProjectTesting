...
Class InternalAudit_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		if(!empty($record) && $request->get('isDuplicate') == true) {
			...
			$recordModel->set('cf_8544', $currentUserModel->get('department_id'));
			$recordModel->set('cf_8540', $currentUserModel->get('location_id'));
