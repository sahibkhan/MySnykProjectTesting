	                ...
	                foreach ($docs as $key => $value)
	                {
                        ...
                        $validatefile = array_pop($image_name);
	                        ...
	                        elseif (!empty($fileName) && in_array($validatefile, $allowTypes))
	                        {
	                            ...
	                            $query = 'INSERT INTO vtiger_edocumentsrecords(job_id,job_refnumber,document_name,edocumentsid,upload_document,upload_document_clone,doc_path,file_name)VALUES(?,?,?,?,?,?,?,?)';
	                            $qparams = array($job_id,$job_name,$doc_name,$record_id,$newname, $newname, $targetDir,$fileName);
	                            $adb->pquery($query, $qparams);	
	                        /*else{
