 ...
 */
class EDocuments_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
		...
		//added line for getting one record on job ref basis
		//$listQuery .= ' GROUP BY vtiger_edocuments.name';

		$listQuery .= ' AND vtiger_edocuments.group_by=1 ';
