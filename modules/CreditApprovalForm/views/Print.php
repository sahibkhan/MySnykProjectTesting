...
class CreditApprovalForm_Print_View extends Vtiger_Print_View {
	...
	function process (Vtiger_Request $request)	{
		...
		$prepared_by = $caf_info->get('cf_5127');//Users_Record_Model::getInstanceById($caf_info->get('cf_4851'), 'Users');
		$approved_by = $caf_info->get('cf_5133');//Users_Record_Model::getInstanceById($caf_info->get('cf_4853'), 'Users');
		$endorsed_by = $caf_info->get('cf_5129');//Users_Record_Model::getInstanceById($caf_info->get('cf_4855'), 'Users');
		...
		$this->setValue('prepared_by', $prepared_by, ENT_QUOTES, "UTF-8");
		$this->setValue('approved_by', $approved_by, ENT_QUOTES, "UTF-8");
		$this->setValue('endorsed_by', $endorsed_by, ENT_QUOTES, "UTF-8");
