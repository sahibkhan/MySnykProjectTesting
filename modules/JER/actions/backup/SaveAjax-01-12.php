		...
		{	
			...
			*/	
			   ...
			   $source_id = $request->get('sourceRecord');
				...
				$params_jobexpencereport= array($current_id, 'Job Costing Buy');			
				...
				$jobexpencereportcf_insert_query = "INSERT INTO vtiger_jobexpencereportcf(jobexpencereportid, cf_1453, cf_1477, cf_1479, cf_1367, cf_1345, cf_1222, cf_1351, cf_1216, cf_1210, cf_1457) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
				$params_jobexpencereportcf = array($current_id, $cf_1451[$key], $cf_1433[$key], $cf_1435[$key], $cf_1176[$vendor], $cf_1156[$key], $cf_1158[$key], $cf_1160[$key], date('Y-m-d'), date('Y-m-d'), 'Expence');
				...
				//INSERT data in jobexpencereport module from job costing
				$jobexpencereport_insert_query = "INSERT INTO vtiger_jobexpencereport(jobexpencereportid, name) VALUES(?,?)";			
				$params_jobexpencereport= array($current_id, 'Job Costing Sell');			
				$adb->pquery($jobexpencereport_insert_query, $params_jobexpencereport);		
				$jobexpencereportid = $adb->getLastInsertID();
				...
				$jobexpencereportcf_insert_query = "INSERT INTO vtiger_jobexpencereportcf (jobexpencereportid, cf_1455, cf_1477, cf_1479, cf_1445, cf_1355, cf_1234, cf_1236, cf_1242, cf_1457) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
				$params_jobexpencereportcf = array($current_id, $cf_1451[$key], $cf_1433[$key], $cf_1435[$key], $cf_1443[$customer], date('Y-m-d'), $cf_1164[$key], $cf_1166[$key], $cf_1168[$key], 'Selling');
				$adb->pquery($jobexpencereportcf_insert_query, $params_jobexpencereportcf);
				$jobexpencereportcfid = $adb->getLastInsertID();
