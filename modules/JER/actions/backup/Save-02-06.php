...
class JER_Save_Action extends Vtiger_Save_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		$s_params_jobexpencereportcf = array($cf_1451, $cf_1433, $cf_1435, $cf_1443, $cf_1164, $revenue_exchange_rate, $sell_local_currency, 'Selling', $row_jrer_s['jobexpencereportid']);
