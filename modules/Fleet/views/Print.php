...
class Fleet_Print_View extends Vtiger_Print_View {
	...
	function process(Vtiger_Request $request) {		
		...
		$params_fleet_expense = array($fleet_id);
		$result = $adb->pquery($jrer_fleet_sql, $params_fleet_expense);
		//$row_job_jrer_fleet = $adb->fetch_array($result_fleet_expense);
		$fleet_expense_table = '<table width="1024" border=1 cellspacing=0 cellpadding=3><tbody>
								<tr><td width="216"><p><strong>&nbsp;</strong></p></td>
								<td width="246"><p><strong>Budget</strong></p></td>
								<td width="234"><p><strong>Actual </strong></p></td></tr>';
		...
		for($i=0; $i<$adb->num_rows($result); $i++) {
			...
			$fleet_expense_table .='<tr><td width="216"><p><strong>'.$charge_name.'</strong></p></td>
								  <td width="246"><p>'.number_format($cf_1351,2).'</p></td><td width="234"><p>'.number_format($cf_1343,2).'</p></td></tr>';
								  
			$total_cash_requried_new +=$cf_1351; 
			$total_actual +=$cf_1343;					  
			
		}
		$fleet_expense_table .='<tr>
							<td width="216">
							<p>&nbsp;</p>
							</td>
							<td width="246">
		...
		$fleet_expense_table .='<tr><td width="216"><p><strong>&nbsp;Total Cash Required</strong></p></td>
								<td width="246"><p>'.number_format($total_cash_requried_new, 2, '.', ',').'</p></td>
								<td width="234"><p>'.number_format($total_actual, 2, '.', ',').'</p></td></tr>';
